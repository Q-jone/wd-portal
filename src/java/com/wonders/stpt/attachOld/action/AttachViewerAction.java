...
@Component("attachViewerOldAction")
@Scope("prototype")
public class AttachViewerAction extends AbstractParamAction{
	 ...
	 * 
	 */
	@Action(value="/pdfOldPreview",results={@Result(name="pdf",location="/attachPreview/pdfViewer.jsp")})
	public String pdfOldPreview() {
	 ...
	 * 
	 */
	@Action(value="/imageOldPreview",results={@Result(name="image",location="/attachPreview/imageViewer.jsp")})
	public String imageOldPreview() {
		//按fileId查找出该文件的路径以及文件名.
		//该部分代码copy自附件上传组件
		HttpServletRequest request = servletRequest;
		HttpServletResponse response = servletResponse;		
