package com.wonders.stpt.attachOld.model.vo;
...
@Repository("uploadOldFile")
public class UploadFile {
	
	private AttachFileOld attachFile;
	...
	public UploadFile(){
		this.attachFile = new AttachFileOld();
	...
	public UploadFile(AttachFileOld attachFile){
		this.attachFile = attachFile;
	}
	
	
	public UploadFile(File uploadFile,AttachFileOld attachFile){
		AttachUtil attachInstance = AttachUtil.getInstance();
		this.uploadFile = uploadFile;
		AttachFileOld af  = new AttachFileOld();
		//this.setFileAllName(uploadFile.getName());
		this.attachFile = af;
	...
	public AttachFileOld getAttachFileOld() {
		return attachFile;
	}
