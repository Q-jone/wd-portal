...
@Component("configDbUtil")
public class ConfigDbUtil implements ApplicationContextAware {
	...
	public static JdbcTemplate getJdbcTemplate(String source) {
		if (source == null || "".equals(source)) {
			DataSource dataSource = (DataSource) getBean("dataSource2");
