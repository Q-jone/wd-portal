package com.wonders.stpt.attach.model.bo;
...
public class AttachFile implements Serializable{
	...
	@Id  
	@SequenceGenerator(name="t_seq_attach", sequenceName="SEQ_PORTAL_ATTACH",allocationSize=1,initialValue=1)
	//@SequenceGenerator(name="t_seq_attach", sequenceName="SEQ_PORTAL_ATTACH") 
