 ...
 *  
 */
public class DJStfbPage {
	public static int getAllResultCount(String sj_id,String searchWord,int pageSize,int page){
		...
		sql = sql1+sqlTop+sqlTail+" union all "+sql2+sqlTop+sqlTail;
		sql = "select * from ("+sql+")";	
	...
	public static List<InfoDetailVo> getAllResult(String sj_id,String searchWord,int beginIndex,int pageSize){
		SimpleDateFormat format=new SimpleDateFormat("yyyy-MM-dd");
		format.setTimeZone(TimeZone.getTimeZone("GMT+8")); 
		String today = format.format(new Date());
