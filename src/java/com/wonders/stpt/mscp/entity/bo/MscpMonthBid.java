...
@Entity
@Table(name = "MSCP_MONTH_BID")
public class MscpMonthBid implements Serializable, BusinessObject {

	private String id; // id

	private String bidNum; // bidNum
	...
	@Column(name = "BID_NUM", nullable = true, length = 20)
