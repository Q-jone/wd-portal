...
@Entity
@Table(name = "op_flowwork_process", schema="STPT")
public class FlowWorkProcess implements Serializable{
	...
	/**
	 * 流程状态 0发起未开始（发起人暂存）  1 进行中 2完成 3 否决 4 经分管领导审核同意
	 */
	...
	public String getStateStr(){
		...
		switch(this.state){
			...
			case 4:
				return FlowWorkContents.FLOW_TERMINATE;							
		}
