...
<!--[if IE 6.0]>
	...
	jQuery.notNull = function(options){
		...
		var listOptions = {
			...
			type:'post',
			callback:null,
			url:'/portal/applyProjectList/planList.action?random='+Math.random(),
		    	...
		    	$("#checkboxAll").prop("checked",false);
					...
					if(data!=null && data.list.length >0){
						...
						for(var i=0;i<l.length;i++){
							...
							temp += "<td class='t_l'>"+$.notNull(l[i].PLANNAME) +"</td>";
							...
							temp += "<td class='t_c'><a class='editA' href='javascript:void(0);' planId='"+l[i].ID+"'>编辑</a></td>";
							</s:if>
							temp += "<td class='t_c'><a target='_blank' href='/portal/applyProject/planView.action?id="+l[i].ID+"'>查看</a></td>";
							temp += "</tr>";
						}
	 	...
	 	$(function(){
			...
			$(document).on("click",".clk",function(){
	 		...
	 		$("#addButton").click(function(){
	 			openWinn("/portal/applyProject/plan/add.jsp",new Date().getTime());
	 		})
	 		
	 		$(document).on("click",".editA",function(){
	 			openWinn("/portal/applyProject/planEdit.action?id="+$(this).attr("planId"),$(this).attr("planId"));
	 			return false;
	 		})
...
<%-- 操作页面--%>
	...
	<div class="main">
      ...
      <div class="pt45">
        <div class="tabs_2">
        	<ul>
           		<li class="selected"><a href="/portal/applyProject/plan/list.jsp"><span>计划管理</span></a></li>
        	...
        	<input type="hidden" name="page" id="page" value=""/>
        	 <table width="100%" border="0" cellspacing="0" cellpadding="0">
        	    <tr>
        	     ...
        	     <td>
        	     <input type="text" id="planname_like" name="planname_like" class="input_xxlarge"/>
        	     </td>
        	     <td class="t_r"></td>
        	     <td><input type="hidden" id="type_equal" name="type_equal" value="1"/></td>
        	     <td class="t_r"></td>
		      ...
		      <div class="fn clearfix">
		                  <h5 class="fl"><a href="#" class="colSelect fl">计划管理列表</a></h5>
		             <s:if test='#session.userName=="胡波" || 
					        	#session.userName=="李名敏" ||
					        	#session.userName=="金涛" ||
					        	#session.userName=="黄天印"'>
        	...
        	<table width="100%"  class="table_1" id="mytable">
        				<thead>
                              <tr class="tit">
                                ...
                                <th style="white-space:nowrap;" class="t_l">计划名称</th>
