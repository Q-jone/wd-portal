...
<!--[if IE 6.0]>
       ...
       <![endif]-->
		...
		var addOptions = {
				...
				type:'post',
				callback:null,
				url:'/portal/applyProject/accidentAdd.action',
			    success:function(data){
						if(data !=null && data.length > 0){
							$.unblockUI();
							alert("添加成功");
							window.location.href = "/portal/applyProject/accident/add.jsp";
						}else{
							$.unblockUI();
							alert("添加失败！");
							window.location.href = "/portal/applyProject/accident/add.jsp";
          ...
          <table width="100%"  class="table_1">
           ...
           <tbody>
            <tr>
             ...
             <td colspan="3">
             <textarea id="accidentContent" name="accidentContent" rows="10"></textarea>
             </td>
             </tr>       
               <tr>
