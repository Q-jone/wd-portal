...
<!--[if IE 6.0]>
       ...
       <![endif]-->
		...
		var updateOptions = {
				...
				type:'post',
				callback:null,
				url:'/portal/applyProject/accidentUpdate.action',
           ...
           <thead>
            <th colspan="4" class="t_r">&nbsp;</th>
                               ...
                               <tr>
                                ...
                                <td colspan="3">
                                <textarea rows="10" id="accidentContent" name="accidentContent"><s:property value="bo.accidentContent" escape="0"/></textarea>
                                </td>
                                </tr>
