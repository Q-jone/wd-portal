...
<body>
        <div class="main"> 
          ...
          <div class="clearfix pt45"> 
          	<!--News_list-->
            <div class="mb10 right_main News_list">
...
%>
                ...
                <div class="p10">
<%
if(contentObj.getString("typeId").equals("2") || contentObj.getString("typeId").equals("3")){
...
%>		     
	     			 <p height:32px; class="mb10"> <%= contentObj.getString("txt").replaceAll("/jeecms/u/",jeecmsUrl+"/u/").replaceAll("href=\"/","href=\""+jeecmsUrl+"/").replaceAll("src=\"/","src=\""+jeecmsUrl+"/")%></p>
<% 
}
%>
