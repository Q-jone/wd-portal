...
setbasePath("<%=basePath%>");
		...
		$(document).ready(function(){ 
			...
			getHeadNews("2090");
			getXWTTNews("2089");
			getXWTTPicNews("<%=jeecmsUrl%>",2089);
			getLatestNews("2252","0");//新闻资讯
            ...
            <table>
            	...
            	<tr>
                 ...
                 <ul class="list">
					...
					<li style="background-color:#33ddff"><a href="share_company.jsp" target="_self" onclick="window.open('http://10.1.33.70:8181')">股份公司</a></li>
