...
setbasePath("<%=basePath%>");
		...
		$(document).ready(function(){ 
			...
			getHeadNews("2132");
			getXWTTNews("2133");
			getXWTTPicNews("<%=jeecmsUrl%>",2133);
			getLatestNews("2128","0");//图片新闻
			getLatestNews("2129","1");//企业文化
			getLatestNews("2130","2");//文明创建
			getLatestNews("2131","3");//人物风采
        	...
        	<div class="right_main mb10">
                ...
                <div class="panel_3 mb10">
                	<header class="clearfix"><div class="bg_3 clearfix">
                    	<h5 class="fl file">第四运营公司</h5>
                        <div class="fr tabs_1">
                            <ul>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>图片新闻</span></a></li>
                            	...
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>人物风采</span></a></li>
            ...
            <table>
            	...
            	<tr>
                 ...
                 <ul class="list">
					...
					<li style="background-color:#33ddff"><a href="fourth_operating_company.jsp" target="_self" onclick="window.open('http://10.108.64.242/pub/default.aspx')">第四运营公司</a></li>
