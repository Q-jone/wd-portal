...
setbasePath("<%=basePath%>");
		...
		$(document).ready(function(){ 
			...
			getHeadNews("2216");
			getXWTTNews("2217");
			getXWTTPicNews("<%=jeecmsUrl%>",2217);
			getLatestNews("2215","0");//党建工团
            ...
            <table>
            	...
            	<tr>
                 ...
                 <ul class="list">
					...
					<li style="background-color:#33ddff"><a href="magnetic_levitation_company.jsp" target="_self">磁浮公司</a></li>
                 </ul>
