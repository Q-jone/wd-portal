...
setbasePath("<%=basePath%>");
		...
		$(document).ready(function(){ 
			...
			getHeadNews("2188");
			getXWTTNews("2189");
			getXWTTPicNews("<%=jeecmsUrl%>",2189);
			getLatestNews("2180","0");//首页新闻
			getLatestNews("2181","1");//通知通告
			getLatestNews("2182","2");//法规动态
			getLatestNews("2183","3");//信息前沿
			getLatestNews("2184","4");//信息安全
			getLatestNews("2186","5");//平台改善
			getLatestNews("2187","6");//工作进展
        	...
        	<div class="right_main mb10">
                ...
                <div class="panel_3 mb10">
                	<header class="clearfix"><div class="bg_3 clearfix">
                    	<h5 class="fl file">首页新闻</h5>
                        <div class="fr tabs_1">
                            <ul>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>首页新闻</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>通知通告</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>法规动态</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>信息前沿</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>信息安全</span></a></li>
                            </ul>
                        </div></div>
                    </header>
                    <div class="con">
            ...
            <!--Panel_3-->
                <div class="panel_3 mb10">
                	<header class="clearfix"><div class="bg_3 clearfix">
                        ...
                        <div class="fr tabs_1">
                            <ul>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>平台改善</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>工作进展</span></a></li>
                            </ul>
                        </div></div>
                    </header>
                    <div class="con">
            ...
            <table>
            	...
            	<tr>
                 ...
                 <ul class="list">
					...
					<li style="background-color:#33ddff"><a href="information_center.jsp" target="_self">信息中心</a></li>
