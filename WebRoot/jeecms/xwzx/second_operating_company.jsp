...
setbasePath("<%=basePath%>");
		...
		$(document).ready(function(){ 
			...
			getHeadNews("2116");
			getXWTTNews("2117");
			getXWTTPicNews("<%=jeecmsUrl%>",2117);
			getLatestNews("2109","0");//员工培训
			getLatestNews("2110","1");//品牌服务
			getLatestNews("2111","2");//公益地铁
			getLatestNews("2112","3");//地铁文化
			getLatestNews("2113","4");//媒体看地铁
			getLatestNews("2115","5");//好人好事
         ...
         <div class="clearfix pt45">
        	<div class="right_main mb10">
                ...
                <div class="panel_3 mb10">
                	<header class="clearfix"><div class="bg_3 clearfix">
                    	<h5 class="fl file">员工培训</h5>
                        <div class="fr tabs_1">
                            <ul>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>员工培训</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>品牌服务</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>公益地铁</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>地铁文化</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>媒体看地铁</span></a></li>
                            </ul>
                        </div></div>
                    </header>
                    <div class="con">
               ...
               <!--Panel_3-->
                <div class="panel_3 mb10">
                	<header class="clearfix"><div class="bg_3 clearfix">
                    	<h5 class="fl file">好人好事</h5>
                        <div class="fr tabs_1">
                            <ul>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>好人好事</span></a></li>
            ...
            <table>
                ...
                <ul class="list">
					...
					<li style="background-color:#33ddff"><a href="second_operating_company.jsp" target="_self">第二运营公司</a></li>
