...
setbasePath("<%=basePath%>");
		...
		$(document).ready(function(){ 
			...
			getHeadNews("2212");
			getXWTTNews("2213");
			getXWTTPicNews("<%=jeecmsUrl%>",2213);
			getLatestNews("2253","0");//新闻资讯
        	...
        	<div class="right_main mb10">
                ...
                <div class="panel_3 mb10">
                	<header class="clearfix"><div class="bg_3 clearfix">
                        ...
                        <div class="fr tabs_1">
                            <ul>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>新闻资讯</span></a></li>
                            </ul>
                        </div></div>
                    </header>
                    <div class="con">
            ...
            <table>
            	...
            	<tr>
                 ...
                 <ul class="list">
					...
					<li style="background-color:#33ddff"><a href="HuangPu_River_build_company.jsp" target="_self">黄浦江大桥建设公司</a></li>
