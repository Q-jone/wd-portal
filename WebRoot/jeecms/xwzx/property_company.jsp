...
setbasePath("<%=basePath%>");
		...
		$(document).ready(function(){ 
			...
			getHeadNews("2085");
			getXWTTNews("2086");
			getXWTTPicNews("<%=jeecmsUrl%>",2086);
			getLatestNews("2201","0");//业务工总信息
			getLatestNews("2202","1");//党纪工团
			getLatestNews("2084","2");//企业文化建设
        	...
        	<div class="right_main mb10">
                ...
                <div class="panel_3 mb10">
                	<header class="clearfix"><div class="bg_3 clearfix">
                    	<h5 class="fl file">资产公司</h5>
                        <div class="fr tabs_1">
                            <ul>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>业务工作信息</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>党纪工团</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>企业文化建设</span></a></li>
            ...
            <table>
            	...
            	<tr>
                 ...
                 <ul class="list">
					...
					<li style="background-color:#33ddff"><a href="property_company.jsp" target="_self" onclick="window.open('http://10.88.0.110')">资产公司</a></li>
