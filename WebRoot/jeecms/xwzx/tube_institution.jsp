...
setbasePath("<%=basePath%>");
		...
		$(document).ready(function(){ 
			...
			getHeadNews("2207");
			getXWTTNews("2208");
			getXWTTPicNews("<%=jeecmsUrl%>",2208);
			getLatestNews("2204","0");//工程动态
			getLatestNews("2205","1");//企业文化
			getLatestNews("2206","2");//获奖成果
         ...
         <div class="clearfix pt45">
        	<div class="right_main mb10">
                ...
                <div class="panel_3 mb10">
                	<header class="clearfix"><div class="bg_3 clearfix">
                    	<h5 class="fl file">隧道设计院</h5>
                        <div class="fr tabs_1">
                            <ul>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>工程动态</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>企业文化</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>获奖成果</span></a></li>
                            </ul>
                        </div></div>
                    </header>
                    <div class="con">
            ...
            <table>
                ...
                <ul class="list">
					...
					<li style="background-color:#33ddff"><a href="tube_institution.jsp" target="_self">隧道设计院</a></li>
