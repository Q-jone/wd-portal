...
setbasePath("<%=basePath%>");
		...
		$(document).ready(function(){ 
			...
			getHeadNews("2176");
			getXWTTNews("2177");
			getXWTTPicNews("<%=jeecmsUrl%>",2177);
			getLatestNews("2172","0");//培训简报
			getLatestNews("2173","1");//培训标准
			getLatestNews("2174","2");//培训资料
			getLatestNews("2175","3");//培训通告
        	...
        	<div class="right_main mb10">
                ...
                <div class="panel_3 mb10">
                	<header class="clearfix"><div class="bg_3 clearfix">
                    	<h5 class="fl file">培训简报</h5>
                        <div class="fr tabs_1">
                            <ul>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>培训简报</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>培训标准</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>培训资料</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>培训通告</span></a></li>
                            </ul>
                        </div></div>
                    </header>
                    <div class="con">
            ...
            <table>
            	...
            	<tr>
                 ...
                 <ul class="list">
					...
					<li style="background-color:#33ddff"><a href="training_center.jsp" target="_self">培训中心</a></li>
