...
setbasePath("<%=basePath%>");
		...
		$(document).ready(function(){ 
			...
			getHeadNews("2124");
			getXWTTNews("2125");
			getXWTTPicNews("<%=jeecmsUrl%>",2125);
			getLatestNews("2122","0");//文明之窗
			getLatestNews("2123","1");//运营简报
         ...
         <div class="clearfix pt45">
        	<div class="right_main mb10">
                ...
                <div class="panel_3 mb10">
                	<header class="clearfix"><div class="bg_3 clearfix">
                    	<h5 class="fl file">第三运营公司</h5>
                        <div class="fr tabs_1">
                            <ul>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>文明之窗</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>运营简报</span></a></li>
            ...
            <table>
                ...
                <ul class="list">
					...
					<li style="background-color:#33ddff"><a href="third_operating_company.jsp" target="_self" onclick="window.open('http://10.83.0.83/')">第三运营公司</a></li>
