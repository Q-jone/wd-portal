...
setbasePath("<%=basePath%>");
		...
		$(document).ready(function(){ 
			...
			getHeadNews("2154");
			getXWTTNews("2155");
			getXWTTPicNews("<%=jeecmsUrl%>",2155);
			getLatestNews("2156","0");//简报
			getLatestNews("2152","1");//工程管理
			getLatestNews("2153","2");//质量安全
        	...
        	<div class="right_main mb10">
                ...
                <div class="panel_3 mb10">
                	<header class="clearfix"><div class="bg_3 clearfix">
                    	<h5 class="fl file">建管中心</h5>
                        <div class="fr tabs_1">
                            <ul>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>简报</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>工程管理</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>质量安全</span></a></li>
                            </ul>
                        </div></div>
                    </header>
                    <div class="con">
            ...
            <table>
            	...
            	<tr>
                 ...
                 <ul class="list">
					...
					<li style="background-color:#33ddff"><a href="Connecting_center.jsp" target="_self">建管中心</a></li>
