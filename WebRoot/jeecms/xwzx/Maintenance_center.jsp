...
setbasePath("<%=basePath%>");
		...
		$(document).ready(function(){ 
			...
			getHeadNews("2139");
			getXWTTNews("2140");
			getXWTTPicNews("<%=jeecmsUrl%>",2140);
			getLatestNews("2136","0");//基层信息
			getLatestNews("2137","1");//党群园地
			getLatestNews("2138","2");//廉政建设
        	...
        	<div class="right_main mb10">
                ...
                <div class="panel_3 mb10">
                	<header class="clearfix"><div class="bg_3 clearfix">
                    	<h5 class="fl file">维保中心</h5>
                        <div class="fr tabs_1">
                            <ul>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>基层信息</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>党群园地</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>廉政建设</span></a></li>
            ...
            <table>
            	...
            	<tr>
                 ...
                 <ul class="list">
					...
					<li style="background-color:#33ddff"><a href="Maintenance_center.jsp" target="_self">维保中心</a></li>
