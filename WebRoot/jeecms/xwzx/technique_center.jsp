...
setbasePath("<%=basePath%>");
		...
		$(document).ready(function(){ 
			...
			getLatestNews("2159","0");//项目信息
			getLatestNews("2160","1");//行业动态
			getLatestNews("2161","2");//通知通告
			getLatestNews("2162","3");//技术成果
			getLatestNews("2163","4");//企业标准
			getLatestNews("2165","5");//节能环保
			getLatestNews("2166","6");//文件下载
			getLatestNews("2167","7");//动态杂志
        	...
        	<div class="right_main mb10">
                ...
                <div class="panel_3 mb10">
                	<header class="clearfix"><div class="bg_3 clearfix">
                    	<h5 class="fl file">项目信息</h5>
                        <div class="fr tabs_1">
                            <ul>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>项目信息</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>行业动态</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>通知通告</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>技术成果</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>企业标准</span></a></li>
                            </ul>
                        </div></div>
                    </header>
                    <div class="con">
               ...
               <!--Panel_3-->
                <div class="panel_3 mb10">
                	<header class="clearfix"><div class="bg_3 clearfix">
                    	<h5 class="fl file">节能环保</h5>
                        <div class="fr tabs_1">
                            <ul>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>节能环保</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>文件下载</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>动态杂志</span></a></li>
            ...
            <table>
            	...
            	<tr>
                 ...
                 <ul class="list">
					...
					<li><a href="Pipe_center.jsp" target="_self" onclick="window.open('http://10.20.1.100')">运管中心</a></li>
					<li><a href="Connecting_center.jsp" target="_self">建管中心</a></li>
					<li style="background-color:#33ddff"><a href="technique_center.jsp" target="_self">技术中心</a></li>
