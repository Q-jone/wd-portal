...
setbasePath("<%=basePath%>");
		...
		$(document).ready(function(){ 
			...
			getHeadNews("2197");
			getXWTTNews("2198");
			getXWTTPicNews("<%=jeecmsUrl%>",2198);
			getLatestNews("2192","0");//资本金银行贷款
			getLatestNews("2193","1");//预算执行情况
			getLatestNews("2194","2");//税务信息
			getLatestNews("2195","3");//票务收入
			getLatestNews("2196","4");//财务报表
        	...
        	<div class="right_main mb10">
                ...
                <div class="panel_3 mb10">
                	<header class="clearfix"><div class="bg_3 clearfix">
                    	<h5 class="fl file">资金中心</h5>
                        <div class="fr tabs_1">
                            <ul>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>资本金银行贷款</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>预算执行情况</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>税务信息</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>票务收入</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>财务报表</span></a></li>
                            </ul>
                        </div></div>
                    </header>
                    <div class="con">
            ...
            <table>
            	...
            	<tr>
                 ...
                 <ul class="list">
					...
					<li style="background-color:#33ddff"><a href="fund_center.jsp" target="_self">资金中心</a></li>
