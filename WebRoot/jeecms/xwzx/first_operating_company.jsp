...
setbasePath("<%=basePath%>");
		...
		$(document).ready(function(){ 
			...
			getHeadNews("2105");
			getXWTTNews("2106");
			getXWTTPicNews("<%=jeecmsUrl%>",2106);
			getLatestNews("2100","0");//党建工团
			getLatestNews("2101","1");//文明创建
			getLatestNews("2102","2");//企业文化
			getLatestNews("2103","3");//3D报
			getLatestNews("2104","4");//公告
...
<body>
	<div class="main mw1002">
		...
		<div class="ctrl clearfix">
            ...
            <div class="posi fl">
            	<ul>
                	<li><a href="javascript:window.location.href='/portal/center/xwzx/xw_index.jsp'">第一运营公司</a></li>
                	<li class="fin">首页</li>
                </ul>
            </div>
         ...
         <div class="clearfix pt45">
                	...
                	<header class="clearfix"><div class="bg_3 clearfix">
                        ...
                        <div class="fr tabs_1">
                            <ul>
                            	...
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>3D报</span></a></li>
                            	<li class="reportLi" ><a href="javascript:void(0);"><span>公告</span></a></li>
                            </ul>
                        </div></div>
                    </header>
                    <div class="con">
            ...
            <table>
                ...
                <ul class="list">
				    ...
				    <li style="background-color:#33ddff"><a href="first_operating_company.jsp" target="_self" onclick="window.open('http://10.61.1.160')">第一运营公司</a></li>
