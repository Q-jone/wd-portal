			...
			<div class="main clearfix">
				...
				<marquee style="text-align:left; margin-left: 30px" width="600" height="40" behavior="scroll" scrollamount="5" onmouseout="this.start()" onmouseover="this.stop()" class="fl">
                    <div id="maq">
                        ...
                        <!-- 2015 0324 新增-->
                        <li>
                            <a href="subIndex.jsp?zyxwId=2424&tzggid=2434" target="_blank">十号线项目公司党支部</a>
                        </li>
                        <li>
                            <a href="subIndex.jsp?zyxwId=2424&tzggid=2434" target="_blank">十二号线项目公司党支部</a>
                        </li>
                        <li>
                            <a href="subIndex.jsp?zyxwId=2424&tzggid=2434" target="_blank">十三号线项目公司党支部</a>
                        </li>
                        <li>
                            <a href="subIndex.jsp?zyxwId=2424&tzggid=2434" target="_blank">申嘉线项目公司党支部</a>
                        </li>
                        <li>
                            <a href="subIndex.jsp?zyxwId=2424&tzggid=2434" target="_blank">申松线项目公司党支部</a>
                        </li>
                        <li>
                            <a href="subIndex.jsp?zyxwId=2424&tzggid=2434" target="_blank">运营人力资源公司党支部</a>
                        </li>
                        <li>
                            <a href="subIndex.jsp?zyxwId=2424&tzggid=2434" target="_blank">股份公司党支部</a>
                        </li>
                        <!-- 2015 0324 新增-->
                        </ul>
                    </div>
