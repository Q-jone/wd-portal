...
<body style="width:750px;height:273px">
    <div class="db">
         <!--<menu class="mb10">
        ...
        <div class="main p10">
            <!------------- 第一style="width:750px;height:273px"个 --------------->
            <div class="clearfix">
                            ...
                            <div class="bg_3">
                                ...
                                <div class="con">
                                    <div class="reportDiv clearfix" id="1">
                                        <ul class="columns clearfix mb10" style="font-size:5px" id="tzgg">
                                        </ul>
                                        <p class="fr"></p>
                                    </div>
                                </div>
