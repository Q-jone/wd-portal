...
//		var zyxwId = "1971";//重要新闻
//		var tzggId = "1971";//通知公告
//		var dyfcId = "1971";//党员风采
//		var zthdId = "1971";//主题活动
//		var zbshId = "1971";//支部生活
//		var jyhdId = "1971";//教育活动
//		var dwgkId = "1971";//党务公开
//		var ghzjId = "1971";//工会之家
//		var tzzshId = "1971";//团组织生活
...
.img {
	margin: 0 auto;
	height: 355px;
	background: url(css/default/images/u70.jpg) left top no-repeat;
	filter:
...
.db-img li {
	...
	letter-spacing: 2px;
	width: 110px;
	background: url(css/default/images/db_img-2.png) left top no-repeat;
}
...
<body>
	<div class="db">
		<menu class="mb10">
			<ul class="main">
				<li class="selected"><a href="#">上海申通地铁集团机关本部</a>
				</li>
				<li><a href="#">工会</a>
				</li>
				<li><a href="#">团委</a>
					...
					<div class="panel_1" style="height:284px;" id="fengcai">
						<div class="bg_2">
							<div class="bg_3">
								...
								<!--focusPic-->
								<div class="focusPic fl" id="play" >
									<ul class="fp_list" id="list">
									</ul>
									<ul class="word" id="info">
									</ul>
								</div>
								<!--focusPic End-->
							</div>
					...
					<div class="panel_4 panel_8 mb10">
						...
						<div class="con clearfix" style="height: 243px;">
							...
							<table width="100%" class="p0">
								<tr>
									<td width="60%" style="height:243px;"><div
											class="gray_border" style="height:243px;">
						...
						<div class="con">
							<div id="list_x" class="reportDiv clearfix">
								<ul class="columns clearfix">
									<li class="clearfix"><a href="#">颜色(Color)</a><span>01-21</span>
									</li>
								</ul>
								<p class="fr">
							...
							<div id="list_y" class="reportDiv clearfix" style="display:none">
								<ul class="columns clearfix">
									<li class="clearfix"><a href="#">图像(Color)</a><span>06-15</span>
									</li>
								</ul>
								<p class="fr">
									<a class="more_3" href="#">更多</a>
							...
							<div id="list_z" class="reportDiv clearfix" style="display:none">
								<ul class="columns clearfix">
									<li class="clearfix"><a href="#">标记(Color)</a><span>10-25</span>
									</li>
								</ul>
								<p class="fr">
									<a class="more_3" href="#">更多</a>
