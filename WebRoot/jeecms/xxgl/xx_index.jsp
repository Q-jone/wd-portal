...
var jsbzId="1959";//技术标准
var flfgId="1960";//法律法规
var pxclId="1961";//培训材料
var zcId="1962";//政策
//规划与制度
var txjsId="1955";//体系建设
var xxghId="1956";//信息规划
//技术与服务
var xxqyId="1966";//信息前沿
var yyznId="1967";//应用指南
//建设及运行
var xmjsId="1992";//项目建设
var ywqkId="1969";//运维情况
...
setbasePath("<%=basePath%>");
		...
		getLatestNews(aqdtId,"1");
	        getLatestNews(jsbzId,"2");
	        getLatestNews(flfgId,"3");
	        getLatestNews(pxclId,"4");
	        getLatestNews(zcId,"5");
	        getLatestNews(txjsId,"6");
	        getLatestNews(xxghId,"7");
	        getLatestNews(xxqyId,"8");
	        getLatestNews(yyznId,"9");
			getLatestNews(xmjsId,"10");
			getLatestNews(ywqkId,"11");
         ...
         <div class="clearfix pt45">
            ...
            <aside>
            	<div class="panel_1"><div class="bg_2"><div class="bg_3">
           			<hgroup>
                    	<h3>业务申请</h3>
                        <a href="/portal/jeecms/findByPage.action?channelId=1964" target="_blank" class="more_1">帮助</a>
                	</hgroup>
                	<div class="con">
                        <ul class="xx clearfix mb10">
                        	...
                        	<li style="margin-bottom:18px;">
                            	<a href="http://10.1.44.18/software/InfoProjectApply.xls" target="_blank">
                                	<dl>
                                    	<dt class="d6"></dt>
                                        <dd>信息化<br>项目申报</dd>
                                    </dl>
            ...
            <div class="clear"></div>
                <!--Panel_3-->
                <!--<div class="panel_3 mb10 clearfix">
                	<div class="fl QAA">
                        <header>
                          <input type="text" name="textfield" id="textfield" class="w360 mr8">
                          <input name="" type="button" value="搜索答案">
                          <input name="" type="button" value="我要提问">
                          <input name="" type="button" value="我要回答">
                        </header>
                        <div class="con clearfix">
                            <div class="w47p fl">
                            	<h4>我的提问</h4>
                                <ul class="full">
                                	<li class="clearfix"><a href="#" class="fl">我的提问</a><span class="fr"><strong class="L_07">1</strong>回答</span></li>
                                	<li class="clearfix"><a href="#" class="fl">我的提问</a><span class="fr"><strong class="L_07">1</strong>回答</span></li>
                                	<li class="clearfix"><a href="#" class="fl">我的提问</a><span class="fr"><strong class="L_07">1</strong>回答</span></li>
                                	<li class="clearfix"><a href="#" class="fl">我的提问</a><span class="fr"><strong class="L_07">1</strong>回答</span></li>
                                </ul>
                            ...
                            <div class="w47p fr">
                            	<h4>常见问题</h4>
                                <ul class="full">
                                	<li class="clearfix"><a href="#" class="fl">常见问题</a><span class="fr"><strong class="L_07">1</strong>回答</span></li>
                                	<li class="clearfix"><a href="#" class="fl">常见问题</a><span class="fr"><strong class="L_07">1</strong>回答</span></li>
                                	<li class="clearfix"><a href="#" class="fl">常见问题</a><span class="fr"><strong class="L_07">1</strong>回答</span></li>
                                	<li class="clearfix"><a href="#" class="fl">常见问题</a><span class="fr"><strong class="L_07">1</strong>回答</span></li>
                                </ul>
                    ...
                    <div class="fr liveuser">
                    	<h4>活跃用户</h4>
                        <ul>
                        	<li class="clearfix"><span class="ID">Limingmin</span><span class="fr"><span class="L_07">123</span>/35</span></li>
                        	<li class="clearfix"><span class="ID">Limingmin</span><span class="fr"><span class="L_07">123</span>/35</span></li>
                        	<li class="clearfix"><span class="ID">Limingmin</span><span class="fr"><span class="L_07">123</span>/35</span></li>
                        	<li class="clearfix"><span class="ID">Limingmin</span><span class="fr"><span class="L_07">123</span>/35</span></li>
                        	<li class="clearfix"><span class="ID">Limingmin</span><span class="fr"><span class="L_07">123</span>/35</span></li>
                ...
                <div class="panel_3 mb10">
                	<header class="clearfix">
                    	<h5 class="file">轨道交通网络信息化总体情况</h5>
                    </header>
                    <div class="con">
                    	<div class="w47p fl clearfix xx">
                        	<table cellpadding="0" cellspacing="0" border="0" width="100%">
                            	<tr>
                                	<td width="172"><img class="mr5" src="css/default/images/content.jpg" /></td>
                                    <td>
                                    	<b>项目建设中</b>
                            		</td>
                                </tr>
                    	...
                    	<div class="w47p fl clearfix xx">
                        	<table cellpadding="0" cellspacing="0" border="0" width="100%">
                            	<tr>
                                	<td width="172"><img class="mr5" src="css/default/images/ILLUST3.jpg" /></td>
                                    <td>
                                    	<b>项目建设中</b>
                            		</td>
                                </tr>
        ...
        <!--Panel_3-->
                	...
                	<header class="clearfix">
                    	...
                    	<div id="tabs2" class="fr tabs_1 clearfix">
                    	  ...
                    	  <ul class="fl">
						    ...
						    <li class="reportLi"><a href="javascript:void(0);"><span>政策</span></a></li>
            ...
            <tr>
                ...
                <div class="panel_3 mb10">
                    ...
                    <div class="con">                        
                        <div class="reportDiv clearfix">
                        	<iframe src="http://10.1.41.51/www_new/zdgztj.asp" frameborder="0" width="100%;"></iframe>
                        </div>
                    </div>
                </div>
                <!--Panel_3 End-->
