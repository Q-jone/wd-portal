$(function(){
			$('#starttime').datepicker({
				...
				"closeText":'清除',	
				"currentText":'starttime'//仅作为“清除”按钮的判断条件						
			});
			...
			$('#endtime').datepicker({
				...
				"showButtonPanel":true,	
				"closeText":'清除',	
				"currentText":'endtime'//仅作为“清除”按钮的判断条件
			});	
            ...
            $(".ui-datepicker-close").live("click", function (){              
              if($(this).parent("div").children("button:eq(0)").text()=="starttime") $("#starttime").val("");
              if($(this).parent("div").children("button:eq(0)").text()=="endtime") $("#endtime").val("");     
