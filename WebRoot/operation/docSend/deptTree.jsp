...
<link rel="stylesheet" href="../../ztree/css/zTreeStyle/zTreeStyle.css" type="text/css">
	...
	<script src="../../ztree/jquery.ztree.all-3.4.js"></script>
	...
	<script type="text/javascript">
		...
		var setting = {
			async: {
				enable: true,
				url:"<%=path %>/opDic/getChildNodes.action",
...
<%-- 			$.ajax({
				type: 'POST',
				url: '<%=path %>/opDic/getNodesByType.action?random='+Math.random(),
				data:{
						"id":checkNodes
					},
				dataType:'json',
...
/* 				}  
		...
		function initRootNodes(){
			if(zNodes==""){
				var url = "<%=path %>/opDic/getNodesByType.action";
				$.getJSON(
					url,
					{
						typecode:root,
