	...
	<div class="main">
		...
		<div class="ctrl clearfix">
            ...
            <div class="posi fl">
            	<ul>
                	...
                	<li><a href="javascript:void(0);">项目统计信息</a></li>
                	<li class="fin">合同统计信息查询</li>
                </ul>
            </div>
      ...
      <div class="filter" id="queryArea">
        	...
        	<div class="p8 filter_search">
      	    ...
      	    <s:form action="list" id="form" method="post"  namespace="/htxx" theme="simple">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr id="search1">
								...
								<td style="white-space:nowrap">
									<input type="text" name="projectNo"  class="input_xlarge" value="<s:property value='#request.projectNo'/>">
								</td>
							...
							<tr id="search2">
								...
								<td style="white-space:nowrap">
									<input type="text" name="contractNo"  class="input_xlarge" value="<s:property value='#request.contractNo'/>" />
								</td>
        ...
        <div class="mb10">
        	<table width="100%"  class="table_1" id="dataList">
                              ...
                              <tr class="tit">
                                ...
                                <td class="t_c">合同编号</td>
                                <td class="t_c">合同名称</td>
                                <td class="t_c">合同分类</td>
                                <td class="t_c">甲方（执行）</td> 
                               	<td class="t_c">对方单位</td>
                               	<td class="t_c">采购方式</td>
                                <td class="t_c">合同签约时间</td>
                                <td class="t_c">合同价（万元）</td>
                                <!-- <td class="t_c">统计日期</td> 
                                <td class="t_c">进展次数（月）</td>
                                <td class="t_c">进展次数（年）</td>
                                <td class="t_c">进展次数（总）</td>-->
                                <!-- <td class="t_c">变更次数（月）</td>
                                <td class="t_c">变更次数（年）</td> -->
                                <td class="t_c">变更次数</td>
                                <!-- <td class="t_c">变更金额（月）</td>
                                <td class="t_c">变更金额（年）</td> -->
                                <td class="t_r">变更金额</td>
                                <td class="t_r">变更后合同价</td>
                                <td class="t_r">决算价(万元)</td>
                                <!--<td class="t_c">变更比例（月）</td>
                                <td class="t_c">变更比例（年）</td>-->
                                <td class="t_r">变更比例</td>
                                <!-- 
                                <td class="t_r">计划支付金额（月）</td>
                                <td class="t_r">实际支付金额（月）</td>
                                 -->
                                <td class="t_r">计划支付金额（年）</td>
                                <td class="t_r">实际支付金额（年）</td>
                                <td class="t_r">开累计划支付金额</td>
                                <td class="t_r">开累实际支付金额</td>
                                <!-- <td class="t_c">计划支付比例（月）</td>
                                <td class="t_c">计划支付比例（年）</td> -->
                                <td class="t_r">开累计划支付比例</td>
                                <!-- <td class="t_c">实际支付比例（月）</td>
                                <td class="t_c">实际支付比例（年）</td> -->
                              ...
                              <tr >
                              	...
                              	<td class="t_c"></td>
                              	<td class="t_c" style="white-space: nowrap;"><s:property value="#request.projectList.get(#s.index).get(0).get('PROJECT_TYPE')"/></td>
                              	<td class="t_l" style="white-space: nowrap;"><s:property value="#items.project_no"/></td>
                              	<td class="t_r" name="Price"><s:property value="#request.projectList.get(#s.index).get(0).get('project_budget_all')"/></td>
                              	<td class="t_l" style="white-space: nowrap;"><s:property value="#items.project_name"/></td>
                              	<td class="t_c" style="white-space: nowrap;"><s:property value="#request.projectList.get(#s.index).get(0).get('MONEY_SOURCE_TYPE')"/></td>
                              	<td class="t_l" style="white-space: nowrap;" title="<s:property value="#contract.contractNo"/>">
                              		<s:property value="#items.contract_no"/>
                              	</td>
                               	<td class="t_l" style="white-space: nowrap;" ><s:property value="#items.contract_name" /></td>
                                <td class="t_l" style="white-space: nowrap;" >
                                <s:if test="#items.contract_type!=null && #items.contract_type!=''">
										<s:if test="#items.contract_type.substring(0,1)==1">
											建设类
											-
											<s:if test="#items.contract_type.substring(2,3)==1">工程类</s:if>
											<s:elseif test="#items.contract_type.substring(2,3)==2">勘察类</s:elseif>
											<s:elseif test="#items.contract_type.substring(2,3)==3">设计类</s:elseif>
											<s:elseif test="#items.contract_type.substring(2,3)==4">前期类</s:elseif>
											<s:elseif test="#items.contract_type.substring(2,3)==5">其他类</s:elseif>
											<s:elseif test="#items.contract_type.substring(2,3)==6">监理类</s:elseif>
											<s:elseif test="#items.contract_type.substring(2,3)==7">科研类</s:elseif>
											<s:elseif test="#items.contract_type.substring(2,3)==8">咨询类</s:elseif>
										</s:if>
										<s:if test="#items.contract_type.substring(0,1)==2">
											运维类
											-
											<s:if test="#items.contract_type.substring(2,3)==1">服务</s:if>
											<s:elseif test="#items.contract_type.substring(2,3)==2">工程</s:elseif>
											<s:elseif test="#items.contract_type.substring(2,3)==3">货物</s:elseif>
										</s:if>
										<s:if test="#items.contract_type.substring(0,1)==3">
											其他类-其他类
										</s:if>
									</s:if>
                                	<s:else>
                                ...
                                <td class="t_l" style="white-space: nowrap;"><s:property value="#items.contract_owner_execute_name"/></td>
                                <td class="t_l" style="white-space: nowrap;"><s:property value="#items.build_supplier_name"/></td>
                                <td class="t_c" style="white-space: nowrap;"><s:property value="#items.invite_bid_type"/></td>
                                <td class="t_l" style="white-space: nowrap;"><s:property value="#items.contract_signed_date"/></td>
                                <td class="t_r" style="white-space: nowrap;" name="contractPrice"><s:property value="#items.contract_price"/></td>
                                <!-- <td class="t_l" style="white-space: nowrap;"><s:property value="#items.stat_date"/></td> 
                                <td class="t_c"><s:property value="#items.process_count_month"/></td>
                                <td class="t_c"><s:property value="#items.process_count_year"/></td>
                                <td class="t_c"><s:property value="#items.process_count_total"/></td>
                                <td class="t_c"><s:property value="#items.change_count_month"/></td>
                                <td class="t_c"><s:property value="#items.change_count_year"/></td>-->
                                <td class="t_r"><s:property value="#items.change_count_total"/></td>
                                <!-- <td class="t_c"><s:property value="#items.change_money_month"/></td>
                                <td class="t_c"><s:property value="#items.change_money_year"/></td> -->
                                <td class="t_r" name="changePrice"><s:property value="#items.change_money_total"/></td>
                                <td class="t_r" name="changedContractPrice"></td>
                                <td class="t_r" name="Price"><s:property value="#items.final_price"/></td>
                                <!-- <td class="t_c"><s:property value="#items.change_percent_month"/></td>
                                <td class="t_c"><s:property value="#items.change_percent_year"/></td> -->
                                <td class="t_r"><s:property value="#items.change_percent_total"/></td>
                                <!-- 
                                <td class="t_c"><s:property value="#items.pay_plan_money_month"/></td>
                                 <td class="t_c"><s:property value="#items.pay_actual_money_month"/></td>
                                  -->
                                <td class="t_r" name="Price"><s:property value="#items.pay_plan_money_year"/></td>
                                 <td class="t_r" name="Price"><s:property value="#items.pay_actual_money_year"/></td>
                                <td class="t_r" name="Price"><s:property value="#items.pay_plan_money_total"/></td>
                                <td class="t_r" name="Price"><s:property value="#items.pay_actual_money_total"/></td>
                                <!-- <td class="t_c"><s:property value="#items.pay_plan_percent_month"/></td>
                                <td class="t_c"><s:property value="#items.pay_plan_percent_year"/></td> -->
                                <td class="t_r"><s:property value="#items.pay_plan_percent_total"/></td>
                                <!-- <td class="t_c"><s:property value="#items.pay_actual_percent_month"/></td>
                                <td class="t_c"><s:property value="#items.pay_actual_percent_year"/></td> -->
                                <td class="t_r"><s:property value="#items.pay_actual_percent_total"/></td>
                                </tr>
                                </s:iterator>
                              </tbody>
                              <tr class="tfoot">
