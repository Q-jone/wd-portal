			...
			$.ajax({
				...
				success: function(obj){			
					if(obj !=null && obj.length >0){
						...
						$(element).html(option);
						if(flag == 0){
							$(element).val('<s:property value="bo.projectCompany"/>');
						}else if(flag== 1){
							$(element).val('<s:property value="bo.line"/>');
						}else if(flag== 2){
							$(element).val('<s:property value="bo.catalogId"/>');
						}else if(flag== 3){
							$(element).val('<s:property value="bo.typeId"/>');
						}else if(flag== 4){
							$(element).val('<s:property value="bo.majorId"/>');
						}else if(flag== 5){
							$(element).val('<s:property value="bo.status"/>');
						}
           ...
           <thead>
            <th colspan="4" class="t_r">&nbsp;</th>
                              ...
                              <tr>
                               ...
                               <td colspan="3"><input value="<s:property value='bo.bidNum'/>" type="text" id="bidNum" name="bidNum" class="input_xxlarge"/></td>
                               </tr>    
                             <tr>
                                <td class="t_r lableTd">工程名称：</td>
                               <td colspan="3"><input value="<s:property value='bo.projectName'/>" type="text" id="projectName" name="projectName" class="input_xxlarge"/></td>
                             </tr>                 
                             
                              <tr>
                                <td class="t_r lableTd">招标计划：</td>
                                <td>
                                <input value="<s:property value='bo.bidPlanDate'/>" readonly="readonly" type="date" id="bidPlanDate" name="bidPlanDate" value=""/>
        	      				</td>
                                <td class="t_r lableTd">中标金额：</td>
                               	<td><input value="<s:property value='bo.bidAmount'/>" type="text" id="bidAmount" name="bidAmount"/></td>
                               ...
                               <td>
                               <input value="<s:property value='bo.bidInfoDate'/>" readonly="readonly" type="date" id="bidInfoDate" name="bidInfoDate" value=""/>
        	      				</td>
