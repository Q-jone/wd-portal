...
function findData(){
	if(lineStatus==-1){
			...
			success:function(object){
				if(object==null || object==""){
					...
					if(object==null){
						...
						var valueList = [obj.backupThreeSection,obj.backupFourSection,obj.backupSixSection,obj.backupSevenSection,obj.backupEightSection];
						newChartPie(valueList,"chart7");
					}
				}
			}
		});
		...
		window.location.href="showProductionDetailPage.action?lineNo="+$("#lineNoSelect").val()+"&startDate="+startDate+"&endDate="+endDate+"&chartId=7"
	}
}
			...
			<tbody id="tbody">
				...
				<s:iterator value="#request.page.result" id="pm" >
					<tr>
						...
						<td id="td_3"><s:property value="#pm.backupThreeSection"/>&nbsp;</td>
						<td id="td_3"><s:property value="#pm.backupFourSection"/>&nbsp;</td>
						<td id="td_3"><s:property value="#pm.backupSixSection"/>&nbsp;</td>
						<td id="td_3"><s:property value="#pm.backupSevenSection"/>&nbsp;</td>
						<td id="td_3"><s:property value="#pm.backupEightSection"/>&nbsp;</td>
					</tr>
				</s:iterator>
			</tbody>
