...
function findData(){
	if(lineStatus==-1){
			...
			success:function(object){
				if(object==null){
					...
					if(object==null || object==""){
						...
						if(object[object.length-1].metroQualityControlVO!=null){
							for(var i=0; i<object.length; i++){
								if(object[i].metroQualityControlVO!=null){
									controlValue = object[i].metroQualityControlVO.metroOntimeDaily;
								...
								dataList[i] = object[i].metroOntimeDaily==0 ? null : object[i].metroOntimeDaily;
						...
						newChartLine(dataList,dateList,'chart8',getInterval(),controlList); 
					}
				}
			}
		});
		...
		window.location.href="showQualityDetailPage.action?lineNo="+$("#lineNoSelect").val()+"&startDate="+startDate+"&endDate="+endDate+"&chartId=8"
	}
}
			...
			<tbody id="tbody">
				...
				<s:iterator value="#request.page.result" id="pm" >
					<tr>
						...
						<td id="td_3"><s:property value="#pm.metroOntimeDaily"/>&nbsp;</td>
						<td id="td_3"><s:property value="#pm.lastyearQualityVo.metroOntimeDaily"/>&nbsp;</td>
						<td id="td_3"><s:property value="#pm.metroOntimeMonth"/>&nbsp;</td>
						<td id="td_3"><s:property value="#pm.metroOntimeYear"/>&nbsp;</td>
					</tr>
				</s:iterator>
			</tbody>
