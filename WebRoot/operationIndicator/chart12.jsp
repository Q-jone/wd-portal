...
function findData(){
	...
	if(lineStatus==-1){
		...
		window.location.href="showScaleDetailPage.action?lineNo="+$("#lineNoSelect").val()+"&startDate="+startDate+"&endDate="+endDate+"&chartId=12"
	}
}
...
<input id="lastDate" value="<s:property value='#request.lastDate'/>" type="hidden"/>
		      	...
		      	<div class="filter_sandglass p8"><!--这里根据内容做样式调整。1、筛选：filter_sandglass 2、搜索filter_search 3、提示：.filter_tips 背景图会改变。-->
		      	  <table class="nwarp" width="100%" border="0" cellspacing="0" cellpadding="0">
		      	    <tr>
		      	      ...
		      	      <td class="t_r">日期</td>
		     	      <td>
						<!-- <img alt="" src="../images/zoom_out.gif" onclick="javascript:void(0);" style="display: inline"> -->		     	      	
						...
						<!-- <img alt="" src="../images/zoom_in.gif" onclick="javascript:void(0);" style="display: inline"> -->
		...
		<table width="100%" class="table_1">
			...
			<s:iterator value="#request.page.result" id="pm" >
				<tr>
					...
					<td id="td_3"><s:property value="#pm.allocateThreeSection"/>&nbsp;</td>
					<td id="td_3"><s:property value="#pm.allocateFourSection"/>&nbsp;</td>
					<td id="td_3"><s:property value="#pm.allocateSixSection"/>&nbsp;</td>
					<td id="td_3"><s:property value="#pm.allocateSevenSection"/>&nbsp;</td>
					<td id="td_3"><s:property value="#pm.allocateEightSection"/>&nbsp;</td>
				</tr>
			</s:iterator>
	...
	<s:form action="showScaleDetailPage" name="scaleIndicator" namespace="/operationIndicator" id="form">
