...
<script type="text/javascript">
      ...
      function selEmp(){
    	    ...
    	    window.showModalDialog('/portal/zdocsCatalog/selEmp.action?deptId=${parentDir.deptId}',window,'dialogWidth:250px;dialogHeight:400px;scroll:auto');
    	}
...
<body>
	...
	<input type="hidden" name="pid" value="${parentDir.sid}"/>
	<input type="hidden" name="empIds" id="empIds"/>
	<table class="toolTbl">
	<tr>
		<td><font class="redMark">*&nbsp;</font>目录名称：</td>
		<td><input type="text" name="catalogName" id="catalogName"/></td>
	</tr>
	<s:if test="#request.parentDir.flag==100">
	<tr>
		<td>可浏览此目录的人员：</td>
		<td><input type="text" name="empNames" id="empNames" readonly="readonly"/>
