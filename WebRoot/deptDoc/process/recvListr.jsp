...
<%-- 操作页面--%>
	...
	<div class="main">
      ...
      <div class="pt45">
        <div class="tabs_2">
            <ul>
               <li  class="selected"><a href="<%=path%>/deptDoc/process/recvListr.jsp"><span>行政收文</span></a></li>
               <li><a href="<%=path%>/deptDoc/process/redvListr.jsp"><span>呈批件1</span></a></li>
               ...
               <li><a href="<%=path%>/deptDoc/process/partysendListr.jsp"><span>规范性文件</span></a></li>  
               <li><a href="<%=path%>/deptDoc/process/dcpsendListr.jsp"><span>规范性文件</span></a></li>  
            </ul>
        </div>
