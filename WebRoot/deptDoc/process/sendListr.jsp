...
<!--[if IE 6.0]>
	...
	<script type="text/javascript">
		...
		var listOptions = {
			...
			type:'post',
			callback:null,
			url:'/portal/deptDoc/process/sendList.action?random='+Math.random(),
      ...
      <div class="pt45">
        <div class="tabs_2">
            <ul>
               ...
               <li class="selected"><a href="<%=path%>/deptDoc/process/sendListr.jsp"><span>行政发文</span></a></li> 
