...
<!--[if IE 6.0]>
	...
	<script type="text/javascript">
		...
		var listOptions = {
			...
			type:'post',
			callback:null,
			url:'/portal/deptDoc/process/partysendList.action?random='+Math.random(),
...
<%-- 操作页面--%>
	...
	<div class="main">
      ...
      <div class="pt45">
        <div class="tabs_2">
            <ul>
               <li class="selected"><a href="<%=path%>/deptDoc/process/partysendList.jsp"><span>党委发文</span></a></li>
               <li><a href="<%=path%>/deptDoc/process/dcpsendList.jsp"><span>纪委发文</span></a></li>
            </ul>
        </div>
        	...
        	<input type="hidden" name="page" id="page" value=""/>
        	 <table width="100%" border="0" cellspacing="0" cellpadding="0">
		      ...
		      <div class="fn clearfix">
		                  <h5 class="fl"><a href="#" class="colSelect fl">其他文件</a></h5>
