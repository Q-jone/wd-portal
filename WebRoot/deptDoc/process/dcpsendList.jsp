...
<!--[if IE 6.0]>
    ...
    <script type="text/javascript">
        ...
        var listOptions = {
            ...
            type:'post',
            callback:null,
            url:'/portal/deptDoc/process/dcpsendList.action?random='+Math.random(),
...
<%-- 操作页面--%>
    ...
    <div class="main">
      ...
      <div class="pt45">
        <div class="tabs_2">
            <ul>
               <li><a href="<%=path%>/deptDoc/process/partysendList.jsp"><span>党委发文</span></a></li>
               <li class="selected"><a href="<%=path%>/deptDoc/process/dcpsendList.jsp"><span>纪委发文</span></a></li>
            </ul>
        </div>
