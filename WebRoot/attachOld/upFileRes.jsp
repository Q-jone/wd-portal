...
<%
	...
	String url = request.getContextPath()+"/attachOld/loadFileOldList.action?fileGroup="+fileGroup+"&fileGroupName="+fileGroupName
				+"&fileGroupId="+fileGroupId+"&newGroupId="+newGroupId+"&procType="+procType+"&targetType="+targetType
				+ "&fileCntObjId=" + fileCntObjId+"&attachMemo=" + attachMemo+"&error="+error;
