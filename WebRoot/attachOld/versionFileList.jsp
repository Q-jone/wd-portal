...
<%
	...
	<tr>
		...
		<td style="line-height: 15px"><a href="<%=request.getContextPath()%>/attachOld/downloadOldFile.action?fileId=<%=file.getAttachFileOld().getId()%>&ver=old" target="_blank">下载</a></td>
	</tr>
	<% 
	}
 %>	
