...
<body>
	<div class="main">
		...
		<div class="ctrl clearfix">
        	<div class="fl"><img id="show"  src="../css/default/images/sideBar_arrow_right.jpg" width="46" height="30" alt="收起"></div>
            <div class="posi fl">
            	<ul>
            		<li><a href="javascript:void(0);">信息完善</a></li>
                	<li class="fin">基本信息完善</li>
                </ul>
            </div>
   		</div>
        <!--Ctrl End-->
        ...
        <!--Table-->
        <div class="mb10 pt45">
        <s:form action="stptUserFix" method="post"  namespace="/userManage">
