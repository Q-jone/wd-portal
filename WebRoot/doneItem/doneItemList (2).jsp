	...
	<script type="text/javascript">
	 //跳转到制定页
		...
		function cuibanNew(inci){
			...
			var url = "http://10.1.44.18/sendMsgPerson.action?processName="+processname+"&incident="+incident+""+"&num="+Math.random();
		...
		$(".todoUrl").click(function(){
        	...
        	$(".todoScan").click(function(){
				...
				if(flag){
					...
					var summaryDiv = $(targetTr).find(".summary");
					var groupid = $(summaryDiv).attr("groupid");
					url ="http://10.1.44.18/jobContact/newVersion/jobContactScan.jsp?groupId="+groupid;
			...
			$(".todoUrge").click(function(){
				...
				if(flag){
					...
					if(status == 1){
						url = "http://10.1.44.18/sendMsgPerson.action?"
...
<body>
	...
	<div class="main">
      ...
      <div class="filter">
        	...
        	<s:form action="doneItemList" id="form" method="post"  namespace="/done" theme="simple">
