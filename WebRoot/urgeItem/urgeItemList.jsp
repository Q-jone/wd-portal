...
<!--[if IE 6.0]>
	...
	<script type="text/javascript">
		...
		var handleOptions = {
			...
			type:'post',
			callback:null,
			url:'/portal/urgeItem/urgeDelay.action',
...
<body>
	...
	<div class="main">
      ...
      <div class="filter">
        	...
        	<s:form action="urgeItemList" id="form" method="post"  namespace="/urgeItem" theme="simple">
        	...
        	<input type="hidden" name="page" id="page" value="<s:property value="page"/>"/>
		      ...
		      <div class="fn clearfix">
		                  <h5 class="fl"><a href="#" class="fl">待办事项催办列表</a></h5>
        ...
        <div class="mb10">
        	<table width="100%"  class="table_1">
                              ...
                              <tr class="tit">
                                ...
                                <td class="t_c">当前处理人</td>
                                <td class="t_c">备注</td>
                                <td class="t_c">延期时限</td>
                                <td class="t_c">表单</td>
                                <td class="t_c">监控</td>
                                <td class="t_c">延期</td>
                                </tr>
                              ...
                              <tr>
                                ...
                                <td class="t_c"><s:property value="#items.steplabel" escape="0"/></td>
                                ...
                                <td class="t_c"><s:property value="#items.delayDate"/></td>
                                <td class="t_c nwarp">
                                <input type="hidden" value="<s:property value='#items.taskid'/>" id="task_id"/>
                                <input type="hidden" value="<s:property value='#items.assignedtouser'/>" id="task_user_name"/>
                                ...
                                <a href="javascript:void(0);" class="urgeUrl"><img src="../css/default/images/p_open.gif"></a></td>
                                 <td class="t_c nwarp">
                                <input type="hidden" value="<s:property value='#items.taskid'/>" id="task_id"/>
                                <input type="hidden" value="<s:property value='#items.assignedtouser'/>" id="task_user_name"/>
                                <input type="hidden" value="<s:property value='#items.pname'/>" id="model_id"/>
                                ...
                                <input type="hidden" value="<s:property value='#items.processname'/>" id="processName"/>
                                <input type="hidden" value="<s:property value='#items.task_type'/>" id="task_type"/>
                                <a href="javascript:void(0);" class="urgeScan"><img src="../css/default/images/p_but9.gif"></a></td>
                                 <td class="t_c nwarp">
                                <input type="hidden" value="<s:property value='#items.taskid'/>" id="task_id"/>
                                <input type="hidden" value="<s:property value='#items.assignedtouser'/>" id="task_user_name"/>
                                <input type="hidden" value="<s:property value='#items.pname'/>" id="model_id"/>
                                ...
                                <input type="hidden" value="<s:property value='#items.processname'/>" id="processName"/>
                                <input type="hidden" value="<s:property value='#items.task_type'/>" id="task_type"/>
                                <a href="javascript:void(0);" class="urgeDelay"><img src="../css/default/images/p_task_exp.gif"></a></td>
                                </tr>
                                </s:iterator>
                              </tbody>
                              <tr class="tfoot">
                                <td colspan="14"><div class="clearfix"><span class="fl">共<s:property value="#r.pageInfo.totalRow"/>条记录</span>
