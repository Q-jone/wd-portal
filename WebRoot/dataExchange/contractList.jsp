...
<body>
	...
	<div class="main">
      ...
      <div class="filter">
        	...
        	<s:form action="findContractByPage" id="form" method="post" namespace="/dataExchange" theme="simple">
        	...
        	<table width="100%"  class="table_1">
                              ...
                              <tr>
                              		<td class="t_c"><s:property value="#st.index+#request.page.startRow+1"/></td>
                               		<td class="t_c"><s:property value="contractNum"/></td>
									<td class="t_c"><s:property value="contractName"/>
