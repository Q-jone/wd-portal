...
<div class="f_bg_fw">
    <div class="w850">
      ...
      <!--Divab1 End-->  
                            ...
                            <div class="mb10">
                              <table class="table_4 mb10">
                                ...
                                <tr>
                                  ...
                                  <td colspan="3"><input name="contractNum" readonly="true" type="text" size="91"><xsl:attribute name="value"><xsl:value-of select="root/Datas/BasicData/Htxx/ContractNum"/></xsl:attribute></input><input type="button" value="选择" onclick="getContractNum()"/></td>
                                </tr>
                                <tr>
        ...
        <input type="hidden" name="greataContractNum"/>
        </form>
