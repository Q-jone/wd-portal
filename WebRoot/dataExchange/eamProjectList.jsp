...
<body>
	...
	<div class="main">
      ...
      <div class="filter">
        	...
        	<s:form action="findEamProjectByPage" id="form" method="post" namespace="/dataExchange" theme="simple">
        ...
        <div class="mb10">
        	<table width="100%"  class="table_1">
                              <tbody>
			                      ...
			                      <td class="t_c" width="35%">项目名称</td>
			                      <td class="t_c" width="10%">项目分类</td>
			                      <td class="t_c" width="15%">申请单位</td>
			                      <td class="t_c" width="15%">申请人</td>
			                      <td class="t_c" width="10%">数据日期</td>
                              ...
                              <tr>
                              		<td class="t_c"><s:property value="#st.index+#request.page.startRow+1"/></td>
				                   	...
				                   	<td class="t_c"><s:property value="projectClass"/></td>
				                   	<td class="t_c"><s:property value="reportCompany"/></td>
				                   	<td class="t_c"><s:property value="reportPerson"/></td>
				                   	<!-- td class="t_c"><s:date name="createTime" format="yyyy-MM-dd HH:mm:ss"/></td-->
				                   	<td class="t_c"><s:property value="dataDate"/></td>
