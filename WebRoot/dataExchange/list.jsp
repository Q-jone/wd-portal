...
<body>
	...
	<div class="main">
      ...
      <div class="filter">
        	...
        	<s:form action="findByPage" id="form" method="post" namespace="/dataExchange" theme="simple">
        ...
        <div class="mb10">
        	<table width="100%"  class="table_1">
                              <tbody>
			                      ...
			                      <td class="t_c" width="15%">ID</td>
			                      <td class="t_c" width="20%">数据类型</td>
			                      <td class="t_c" width="10%">数据日期</td>
			                      <td class="t_c" width="15%">上传时间</td>
                              ...
                              <tr>
                              		<td class="t_c"><s:property value="#st.index+#request.page.startRow+1"/></td>
                               		<td class="t_c"><s:property value="id"/></td>
									<td class="t_c"><s:property value="dataType"/>
