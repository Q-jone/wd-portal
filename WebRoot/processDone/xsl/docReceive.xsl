                          ...
                          <h1 class="t_c">上海申通地铁集团有限公司<br></br>收文单</h1>
                            ...
                            <div class="mb10">
                               <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_4">
                                  <thead>
                                  <th colspan="4">
                                      <h5 class="fl">收文编号：</h5><span class="fl"><xsl:value-of select="Datas/BasicData/drSwid"/></span>
                                        <span class="fr clearfix">
                                          <h6 class="fl">密级：</h6><span class="fl mr8">
                                          <xsl:value-of select="Datas/BasicData/drSecretClass"/></span>
                                          <h6 class="fl">缓急：</h6><span class="fl mr8">
                                          <xsl:value-of select="Datas/BasicData/priorities"/></span>
                                        </span>
                                    </th>
                                  </thead>
                                  <tr>
                                    <td class="lableTd" width="15%">来文单位</td>
                                    <td width="35%"><xsl:value-of select="Datas/BasicData/drSwunit"/></td>
                                  ...
                                  <td >
                                      <xsl:value-of select="Datas/BasicData/drFilezh"/>
                                  </td>
                                </tr>
                                <tr>
                                  <td class="lableTd" width="15%">文件标题</td>
                                  <td colspan='3'><xsl:value-of select="Datas/BasicData/drTitle"/></td>
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_4"> -->
                                ...
                                <tr>
                                  ...
                                  <td colspan="3">
                                    <xsl:value-of select="Datas/BasicData/remark"/>
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td colspan="4">
                                    ...
                                    <xsl:for-each select="Datas/TApprovedinfoList/TApprovedinfo[stepname='拟办人']">
                                      ...
                                      <div class="node">
                                        <b class="fl">备案情况</b>
                                        <div class="clear"></div>
                                        <xsl:for-each select="Datas/TApprovedinfoList/TApprovedinfo[stepname='备案']">
                                              <xsl:sort select="upddate" order="descending"/>
                                          <div class="con">
                                            <i><xsl:value-of select="dept"/></i>
                                            <p><xsl:value-of select="remark"/></p>
                                ...
                                <!-- <tr>
                                  ...
                                  <xsl:for-each select="">
                                    <td colspan="3"><xsl:value-of select="Datas/BasicData/sendReportW"/></td>
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_4">
                                ...
                                <tr>
                                  ...
                                  <td ><xsl:value-of select="Datas/TApprovedinfoList/TApprovedinfo[stepname='备案']/remark"/></td>
                                </tr> -->
                               <!--  <tr>
