                ...
                <div class="divB">
                  ...
                  <div class="con">
                    <ul class="button clearfix">
                      ...
                      <li>
                        <a href="printProcessInfo.action?id={$pid}" target="blank" class="print">
                          打印</a></li>
               ...
               <dt></dt>
                 <dd>办结阶段</dd>
                            ...
                            <div class="mb10">
                                  ...
                                  <thead>
                                  <th colspan="4">
                                      <h5 class="fl">发文字号：</h5><span class="fl"><xsl:value-of select="Datas/BasicData/sendId"/></span>
                                        <span class="fr clearfix">
                                          <h6 class="fl">文别：</h6><span class="fl mr8"><xsl:value-of select="Datas/BasicData/docClass"/></span>
                                          <h6 class="fl">密别：</h6><span class="fl mr8"><xsl:value-of select="Datas/BasicData/secretClass"/></span>
                                          <h6 class="fl">缓急：</h6><span class="fl mr8"><xsl:value-of select="Datas/BasicData/hj"/></span>
                                        </span>
                                    </th>
                                    </thead>
                                  <tr>
                                ...
                                <tr>
                                  <td width="33%" class="r_bor">
                                    ...
                                    <div class="clearfix">
                                      ...
                                      <div class="fr"><xsl:value-of select="Datas/TApprovedinfoList/TApprovedinfo[stepname='起草' or stepname='拟稿人修改']/upddateStr"/></div>
                                      <div class="fr mr8"><xsl:value-of select="Datas/TApprovedinfoList/TApprovedinfo[stepname='起草' or stepname='拟稿人修改']/userfullname"/></div>
                                    </div>
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_4">
                                ...
                                <tr>
                                  ...
                                  <td ><xsl:if test="Datas/BasicData/sendCopy"> 
            ...
            <td style="word-break: break-all">
              <xsl:value-of select="memo"/>
                                ...
                                <tr>
                                  ...
                                  <td ><xsl:value-of select="Datas/TApprovedinfoList/TApprovedinfo[stepname='校稿']/remark"/>
                                  </td>
                                </tr>
                                <tr>
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_4">
                                <tr>
                                  <td class="r_bor" width="50%">印制份数：<xsl:value-of select="Datas/BasicData/docCount"/></td>
