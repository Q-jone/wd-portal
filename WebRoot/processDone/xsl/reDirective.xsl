      ...
      <!--Divab1 End-->  
        	<div class="gray_bg2">
            	<div class="w_bg">
                	<div>
                    	<div class="Top_fw">
                        	<h1 class="t_c">上海申通地铁集团有限公司<br></br>呈批文件单</h1>
                            ...
                            <div class="mb10">
                              <table class="table_4 mb10">
                                <tr>
                                  <th colspan="4"><h5 class="fl">呈批文件单基本信息栏</h5></th>
                                </tr>
                                <tr>
                                  <td class="t_r lableTd" width="15%">呈报部门：</td>
                                  <td ><xsl:value-of select="Datas/BasicData/submitdept"/></td>
                                   <td class="t_r lableTd" width="15%">呈报日期：</td>
                                  <td ><xsl:value-of select="Datas/BasicData/submitdate"/></td>
                                  
                                </tr>
                                <tr>
                                  <td class="t_r lableTd">部门编号：</td>
                                  <td ><xsl:value-of select="Datas/BasicData/deptid"/></td>
                                   <td class="t_r lableTd" width="15%">关键词：</td>
                                  <td ><xsl:value-of select="Datas/BasicData/drSecretClass"/></td>
                                </tr>
                                <tr>
                                  <td class="t_r lableTd">标题：</td>
                                  <td ><xsl:value-of select="Datas/BasicData/title"/></td>
                                  <td class="t_r lableTd" width="15%">缓急：</td>
                                  <td ><xsl:value-of select="Datas/BasicData/doclevel"/></td>
                                </tr>
                                
                                <tr>
                                  <td class="t_r lableTd">主要内容：</td>
                                  <td  colspan="3"><xsl:if test="Datas/BasicData/content">
                                    <pre>
           ...
           <xsl:for-each select="Datas/AttachFileList/AttachFile">
            ...
            <td style="word-break: break-all">
              <xsl:value-of select="memo"/>
                                ...
                                <tr>
                                  <th colspan="4"><h5 class="fl">呈批文件单流转意见栏</h5></th>
                                </tr>
                                <tr>
                                  <td colspan="4">
                                    <div class="node">
