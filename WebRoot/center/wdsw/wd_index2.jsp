...
<!--[if IE 6.0]>
       ...
       <![endif]-->
		...
		<script src="js/new_ajax2.js"></script>
		<script src="js/wdsw_ajax2.js"></script>	
		...
		var greataUrl = "http://greata/NoticeCollection.aspx?requestType=Received&noticeType=MyNotice&viewname=Process&exceptClosed=1&Wait=1&proc=1";
		$(document).ready(function(){ 
		
			$("#otherTodoDiv").on("click",".otherTodoLi",function(){
				var iamUrl = "http://10.1.14.20:7001/ca/iamCross.jsp?target=GREATA";
				$("#otherTodoIframe").attr("src",iamUrl+"&targeturl="+encodeURIComponent(greataUrl));
	...
	<div class="main mw1002">
            ...
            <div class="fr lit_nav nwarp">
             <!--  <ul class="fr">
               ...
               <div style="padding-top:5px">
					<select style="display:none;" class="fr" id="oldDept" name="oldDept"></select>
              </div>
            </div>
   		</div>
        <!--Ctrl End-->
        ...
        <div class="mb10 clearfix">
			...
			<!--Panel_3-->
                ...
                <div class="clear"></div>
			<!--Panel_3-->
                <div class="panel_3 m6 fl w49p" style="width:98%;">
                	<header class="clearfix">
                    	<div class="bg_3 clearfix">
                            <h5 class="fl wlist1" style="cursor:pointer;" onclick="window.location.href='/portal/todo/todoItemList.action'">待办事项</h5>
                        	<!--<p id="updateNewDbx" class="fr" style="line-height:37px;margin-right:25px;cursor:pointer;">更新</p>-->
                    ...
                    .panel_3 .con ul.zs li {
                    	width:46.5%;
                    }
                    
                    .panel_3 .con ul.zs li a {	
                    	overflow: hidden;
                    ...
                    <div class="con">
                        <div class="clearfix">
                        	<ul id="todolist" class="clearfix zs">
                ...
                <!--Panel_3 End-->
			<!--Panel_3-->
                <div class="panel_3 m6 fr w49p" style="display:none;">
                	<header class="clearfix">
                    	<div class="bg_3 clearfix">
        ...
        <!--Panel_3-->
                <div id="otherTodoDiv" class="panel_3 mb10">
                	<header class="clearfix"><div class="bg_3 clearfix">
                    	<h5 class="fl wlist2">待办事项</h5>
                        <div class="fr tabs_1">
                             <ul>
                            	<li class="reportLi otherTodoLi" ><a href="javascript:void(0);"><span>GREATA</span></a></li>
                            </ul></div></div>
                    </header>
                <div class="con">
                	<iframe src="http://www.baidu.com" id="otherTodoIframe"  width="100%" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="auto" allowtransparency="yes"></iframe>
                </div>
              </div>
                <!--Panel_3 End-->
        ...
        <!-- End-->	
            ...
            <aside class="fr">
            	...
            	<table id="weatherBak" border="0" cellspacing="0" cellpadding="0" style="margin:10px auto;">
			      
			      <tr>
			        <td ><table width="230" border="0" align="center" cellpadding="0" cellspacing="0">
			          <tr>
			            <td>
						<iframe allowtransparency="yes" src="tqyb.jsp" width="230" height="120" border="0" frameborder="0" framespacing="0" marginheight="0" marginwidth="0" scrolling="no"></iframe></td>
			          </tr>
			        </table></td>
			      </tr>
			      <tr>
			    ...
			    <div class="panel_1" ><div class="bg_2" ><div class="bg_3">
           		  <hgroup class="asideH stats_2">
                    	<h5><b>业务统计</b><span style="display:inline;font-size:12px;" class="fr L_01" >统计值4小时更新一次。</span></h5>
                        
                  </hgroup>
                 <ul class="stats_2 stats_2_bg1" id="rightUl">
                 		<li class="blue"><a href="/portal/todo/todoItemList.action" target="_self" style="display:inline">流程待办事项：<h1 id="dbx_num" class="mr5 L_08"></h1><h6>条</h6></a></li> 
                 		...
                 		<li class="blue"><a href="/portal/todo/todoItemList.action" target="_self" style="display:inline">流程超时事项：<h1 id="csx_num" class="mr5 L_08"></h1><h6>条</h6></a></li>
                 		<li class="blue"><a href="/portal/todo/todoItemList.action" target="_self" style="display:inline">最大超时时间：<h1 id="csTime_num" class="mr5 L_08"></h1><h6>天</h6></a></li>
