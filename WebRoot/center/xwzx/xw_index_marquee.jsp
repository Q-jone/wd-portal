...
<!--[if IE 6.0]>
   ...
   <!--	<script src="js/jquery-ui-1.9.2.custom.js"></script>
		...
		var locations = ["http://10.20.1.100/News/newsAction","http://10.83.0.83/admin/NewsManage/NewsStatistics/News_Index.aspx","http://10.108.64.242/pub/companyNews.aspx"];
		...
		<style>
        	...
        	.marquee .ldjh,.hotnews{
        		color:#53868B;
        	}
        	.marquee .mail,.marquee .todo{
        		color:#FF1493;
        	}
        	.marquee.help{
        	...
        	.marquee .yysb,.marquee .yyzb{
        		color:blue;
        	}
        </style>
		
</head>
<!-- <div id="msg" style="z-index:9999;width:400px;border:#c7c7c7 1px solid;
position:absolute;left:600px;top:200px;" class="panel_5">
<div class="tit">
<h4>1111111111 <input type="button" style="float:right;margin:10px;" value="关闭"></h4></div>
<div class="con">
<ul style="line-height:30px;">
<li style="text-indent:2em;">XXXXXXXXXXXXXXXXXXXXX</li>
<li style="text-align:right;">集团党的群众路线教育实践活动领导小组办公室</li>
<li style="text-align:right;">2014年4月8日</li>
</ul>
</div>
</div> -->
<body>
	<div class="main mw1002">
    	<!--Ctrl-->
		<div id="marqueeDiv" class="ctrl clearfix marquee">
		...
		<div id="copyright" class="fl l_bor" style="height:30px;overflow:hidden;">
    	 	<ul id="cul">
    	 	</ul>
    	 </div>
            ...
            <table>
            	...
            	<tr>
                 ...
                 <ul class="list">
				    ...
				    <li><a href="xw_company.jsp?headId=1324&activeId=1335&parentId=1334" target="_self" onclick="window.open('http://10.61.1.160')">第一运营公司</a></li>
					<li ><a href="xw_company.jsp?headId=1325&activeId=1326&parentId=1336" target="_self">第二运营公司</a></li>
					<li><a href="xw_company.jsp?headId=1331&activeId=1340&parentId=1330" target="_self" onclick="window.open('http://10.83.0.83/')">第三运营公司</a></li>
					<li><a href="xw_company.jsp?headId=1343&activeId=1332&parentId=1342" target="_self" onclick="window.open('http://10.108.64.242/pub/default.aspx')">第四运营公司</a></li>
					<li><a href="xw_company.jsp?headId=1347&activeId=1355&parentId=1354" target="_self">维保中心</a></li>
					<li><a href="xw_company.jsp?headId=1357&activeId=1348&parentId=1356" target="_self" onclick="window.open('http://10.20.1.100')">运管中心</a></li>
					...
					<li><a href="xw_company.jsp?headId=1371&activeId=1372&parentId=1384" target="_self" onclick="window.open('http://10.88.0.110')">资产公司</a></li>
					<li><a href="xw_company.jsp?headId=1386&activeId=1373&parentId=1385" target="_self">隧道设计院</a></li>
					<li><a href="xw_company.jsp?headId=1389&activeId=1390&parentId=1395" target="_self" onclick="window.open('http://10.1.33.70:8181')">股份公司</a></li>
