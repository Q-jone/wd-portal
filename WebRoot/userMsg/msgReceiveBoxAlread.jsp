...
<script type="text/javascript">
		$(document).ready( function() {
			...
			$("#unread").click(function(){	
				window.location.href = "msgReceiveBoxUnread.action";
			})
			$("#alread").click(function(){
				window.location.href = "msgReceiveBoxAlread.action";
			})
...
<ul id="msgTab" class="nwarp">
	<li id="unread"><a href="javascript:void(0);"><span>未读通知</span></a></li>
	<li class="selected" id="alread"><a href="javascript:void(0);"><span>已读通知</span></a></li>
</ul>
</div>
<!--Tabs_2 End--> <!--Filter-->
<div class="filter">
<div class="query">
<div class="p8 filter_search"><s:form action="msgReceiveBoxAlread"
	...
	<tbody id="pageTable">
		...
		<s:iterator value="pageResultSet.list" id="msg">
			<tr>
				...
				<td class="t_c"><a class="mr5" href="msgView.action?msgId=<s:property value="#msg.id"/>" target="_blank">查看</a></td>
			</tr>
		</s:iterator>
	</tbody>
	<tr class="tfoot">
		<td style="border-top: #5a84a7 2px solid;" colspan="5">
