...
<ul id="msgTab" class="nwarp">
	<li class="selected" id="unread"><a href="javascript:void(0);"><span>未读通知</span></a></li>
	<li id="alread"><a href="javascript:void(0);"><span>已读通知</span></a></li>
</ul>
</div>
<!--Tabs_2 End--> <!--Filter-->
<div class="filter">
<div class="query">
<div class="p8 filter_search"><s:form action="msgReceiveBoxUnread"
	...
	<tbody id="pageTable">
		...
		<s:iterator value="pageResultSet.list" id="msg">
			<tr>
				...
				<td class="t_c"><a class="mr5" href="msgRead.action?msgId=<s:property value="#msg.id"/>" target="_blank">查看</a></td>
			</tr>
		</s:iterator>
	</tbody>
	<tr class="tfoot">
