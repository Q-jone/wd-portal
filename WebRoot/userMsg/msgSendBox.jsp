...
<ul id="msgTab" class="nwarp">
	...
	<li class="selected" id="sbox"><a href="javascript:void(0);"><span>发件箱</span></a></li>
...
<div class="filter">
<div class="query">
<div class="p8 filter_search"><s:form action="msgSendBox"
...
<h5 class="fl"><a href="#" class="colSelect fl">发件箱</a></h5>&nbsp;
	...
	<tbody id="pageTable">
		...
		<s:iterator value="pageResultSet.list" id="msg">
			<tr>
				...
				<td class="mail_1 <s:if test='#msg.replyId!=null'> mail_re </s:if><s:elseif test='#msg.forwardId!=null'> mail_for </s:elseif><s:else> mail_read </s:else>">&nbsp;</td>
				...
				<td class="t_c"><a class="mr5" href="msgView.action?msgId=<s:property value="#msg.id"/>" target="_self">查看</a></td>
			</tr>
		</s:iterator>
	</tbody>
	<tr class="tfoot">
