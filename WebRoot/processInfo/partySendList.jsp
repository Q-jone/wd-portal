...
<body>
	<div class="main">
      ...
      <div class="filter">
        	...
        	<s:form action="findPartySendByPage" id="form" method="post"  namespace="/processInfo">
        	<input type="hidden" name="page" id="page" value="<s:property value="page"/>"/>
		      ...
		      <div class="fn clearfix">
		                  <h5 class="fl"><a href="#" class="colSelect fl">党委发文统计</a></h5>
                              ...
                              <tr>
                                ...
                                <td>
									<center>
										...
										<s:elseif test="#items[15]=='新党委发文流程'">
