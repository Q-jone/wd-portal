$(function(){
			$('#sign_time_start').datepicker({
				//inline: true								
				"changeYear":true,
				"showButtonPanel":true,	
				"closeText":'清除',	
				"currentText":'sign_time_start'//仅作为“清除”按钮的判断条件						
			});
						
			//$("#indicatorDate").datepicker('option', $.datepicker.regional['zh-CN']); 
			$('#sign_time_end').datepicker({
				//inline: true
				"changeYear":true,
				"showButtonPanel":true,	
				"closeText":'清除',	
				"currentText":'sign_time_end'//仅作为“清除”按钮的判断条件
			});	
            ...
            $(".ui-datepicker-close").live("click", function (){              
              if($(this).parent("div").children("button:eq(0)").text()=="sign_time_start") $("#sign_time_start").val("");
              if($(this).parent("div").children("button:eq(0)").text()=="sign_time_end") $("#sign_time_end").val("");     
