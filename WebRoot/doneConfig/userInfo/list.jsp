...
<html lang="en">
 ...
 $(function(){
  ...
  <!--Ctrl-->
   ...
   <%-- 	当前用户账号为：<s:property value="#session.loginName"/> --%></li>
        ...
        <!--Filter-->
                ...
                <div style="background-color: ;">
		             ...
		             &nbsp;<input type="button"  id="add" name="add" value="修改类型" class="fr">
		           </div>
		      </div>
   <div class="mb10"> <!-- style="border:1px solid #F00;" -->
   <!-- <div style="width:30%;height: 500px;border:1px solid #F00;float: left;font-size:;" id="type" > -->
   <table width="100%">
   <tr>
   <td style="width:30%;background-color: white;"><table style="width:100%;background-color: white;"   class="table_1" ><!-- id="mytable" -->
   <thead>
   ...
   <s:if test="listType.size() <=0"><tr id="dataTr"><td class="t_l"><font color="red">当前账号没有选择类型</font> </td></tr></s:if>
   </tbody>
   </table></td>
   <td style="width:70%;background-color: white;">
   <form action="<%=basePath %>doneConfig/userInfo/deletes.action" method="post" id="" name="">
   <input type="hidden" id="typeId" name="typeId" value='<s:property value="id"/>'/>
   ...
   <table style="width:100%;background-color: white;" class="table_1"  border="1px" cellspacing="0px">
   <thead>
    		<tr class="tit">
   ...
   <s:iterator value="list" var="info" status="l">
   		<tr>
   			<td><s:property value="#l.index+1"/>  <%-- <input type="checkbox"  name="chk" value="<s:property value='id'/>"/> --%></td>
   ...
   <!-- </div>
   <div style="width:48%;height: 500px;border:1px solid #F00;float: left;"> -->
