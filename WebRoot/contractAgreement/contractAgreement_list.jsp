...
<head>
    ...
    <script type="text/javascript">
        ...
        function toDetail(instant_id,process_name,taskid){
            ...
            var url = "http://10.1.48.16:8080/workflow/contractChange-contractMain/forward.action?"
...
<div class="main">
    ...
    <div class="pt45">
        ...
        <div class="filter">
            <div class="query">
                <div class="p8 filter_search">
                    <s:form action="list" id="form" method="post"  namespace="/contractAgreement">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="t_r">合同变更协议名称</td>
                                <td>
                                    <input type="text" id="contractName" name="contractAgreement.contractName" class="input_xlarge" value="<s:property value='contractAgreement.contractName'/>"/>
                                </td>
                                <td class="t_r">合同编号</td>
                                <td>
                                    <input type="text" id="contractNo" name="contractAgreement.contractNo" class="input_xlarge" value="<s:property value='contractAgreement.contractNo'/>"/>
                                </td>
                                <td class="t_r">拟变金额</td>
                                <td>
                                    <input type="text" id="changePrice" name="contractAgreement.changePrice" style="width: 118px;" value="<s:property value='contractAgreement.changePrice'/>"/>
                                    -
                                    <input type="text" id="changePriceEnd" name="contractAgreement.changePriceEnd" style="width: 118px;" value="<s:property value='contractAgreement.changePriceEnd'/>"/>
                                </td>
                            </tr>
                            <tr>
                                <td class="t_r">登记日期</td>
                                <td style="white-space: nowrap">
                                    <input type="text" id="regTimeStart" name="contractAgreement.regTime" style="width: 118px;" value="<s:property value='contractAgreement.regTime'/>">
                                    -
                                    <input type="text" id="regTimeEnd" name="contractAgreement.regTimeEnd" style="width: 118px;"  value="<s:property value='contractAgreement.regTimeEnd'/>">
                                </td>
                                <td class="t_r">登记人</td>
                                <td>
                                    <input type="text" id="regPerson" name="contractAgreement.regPerson" class="input_xlarge" value="<s:property value='contractAgreement.regPerson'/>"/>
                                </td>
                                <td class="t_r">状态</td>
                                <td>
                                    <input type="hidden" id="flag_no" value="<s:property value='contractAgreement.flag'/>"/>
                                    <select style="width:118px" id="flag" name="contractAgreement.flag" class="input_xlarge"/>
        ...
        <div style="background-color: ;">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h5 class="fl"><a href="#" class="colSelect fl">变更协议后备案列表</a></h5>
        </div>
    </div>
    <!--Filter End-->
    <!--Table-->
    ...
    <div class="mb10">
        <table width="100%"  class="table_1" id="mytable">
            ...
            <tr class="tit">
                ...
                <td class="t_c" width="24%">合同变更协议名称</td>
                <td class="t_c" width="25">变更协议自有编号</td>
                <td class="t_c" width="15">合同编号</td>
                <td class="t_c" width="15">对方单位</td>
                <td class="t_c" width="8%">拟变金额（万元）</td>
                <td class="t_c" width="6%">登记时间</td>
                <td class="t_c" width="5%">登记人</td>
                <td class="t_c" width="6%">状态</td>
            ...
            <s:iterator value="r" id="items" status="s">
                <tr id="dataTr">
                    ...
                    <td class="t_l"><s:property value="selfNo"/></td>
                    <td class="t_l"><s:property value="contractNo"/></td>
                    <td class="t_l"><s:property value="oppositeCompany"/></td>
