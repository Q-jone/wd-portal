...
<!--[if IE 6.0]>
	...
	var handleOptions = {
       ...
       function toDetail(mainId, instant_id,process_name){
    	   //http://10.1.44.18/contractInfoDetail.action?id=25007&modelName=%E5%90%88%E5%90%8C%E5%AE%A1%E6%89%B9%E6%B5%81%E7%A8%8B&incidentNo=2454&stepName=Begin&taskId=060909743aed2a969758e1a79785db&taskUserName=ST/G00200000059
			...
			var url = "http://10.1.44.18/contractInfoDetail.action?id="+mainId +"&modelName="+encodeURI(process_name)+"&incidentNo="+encodeURI(instant_id);
		...
		function toSee(instant_id,process_name){
			var url = 'http://10.1.44.18/stoa/publicConn.jsp?urlPath=/htsp/detail.do?b_query=true&type=1&pinstanceid='+encodeURI(instant_id)+'&modelId='+encodeURI(process_name);
			//window.location.href=url;
			window.open(url);
			return false;
		}
...
<%-- 操作页面--%>
	...
	<div class="main">
      ...
      <div class="tabs_2">
        	<ul>
				<li ><a href="/portal/contractManage/newList.action"><span>新合同查询</span></a></li>
      ...
      <div class="filter">
        	...
        	<s:form action="list" id="form" method="post"  namespace="/contractManage">
        ...
        <div class="mb10">
        	<table width="100%"  class="table_1">
                              ...
                              <tr>
                                ...
                                <td class="t_l"><s:property value="#items[4]" escape="0"/></td>
                                ...
                                <td>
									<center>
										<a href="javascript:void(0)" onclick="toDetail('<s:property value="#items[13]" />','<s:property value="#items[11]" />','<s:property value="#items[12]" />');"><img src="../css/default/images/p_open.gif"/></a>
									</center>
								</td>
								<td>
									<center>
