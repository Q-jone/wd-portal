...
<!--[if IE 6.0]>
	...
	<script type="text/javascript">
       ...
       function start(id){
			window.open('../exam/edit.action?examId='+id);
       }       
...
<body>
	<div class="main">
      ...
      <div class="filter">
	        	...
	        	<s:form action="ulist.action" id="form" method="post"  namespace="/examManage">
        ...
        <div class="mb10">
        	<table width="100%"  class="table_1">
                              ...
                              <tr>
                                ...
                                <td class="t_c"> 
                                <a class="mr5" href="javascript:start('<s:property value="#data[0]"/>')"><s:property value="#data[5]==0?'开始考试':'查看答题记录'"/></a>
                                </td>
                                </tr>
                                </s:iterator>
                              </tbody>
