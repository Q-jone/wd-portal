        ...
        <div class="mb10">
        	<table width="100%"  class="table_1">
                              ...
                              <tr>
                                ...
                                <td class="t_c">
                                	<a class="mr5" href="javascript:showApplyPage('<s:property value="#data.MATCH_ID"/>','<s:property value="#data.ID"/>')">查看</a>
                                </td>
                                </tr>
                                </s:iterator>
                              </tbody>
