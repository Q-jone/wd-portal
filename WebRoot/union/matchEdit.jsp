...
<div class="main">
    ...
    <div class="ctrl clearfix">
        ...
        <div class="posi fl">
            <ul>
                <li><a href="$<%=path%>/theme/themes">竞赛名称管理</a></li>
    ...
    <div class="mb10 pt45">
        	...
        	<input type="hidden" name="todoId" value="${match.todoId}"/>        	
            ...
            <table width="100%"  class="table_1">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <a id="selDepartment" style="display:inline;cursor:pointer">选择考评部门经办人</a>
                    </td>
                </tr>
		...
		<jsp:include page="flow/matchAdd_modify.jsp"/>    
    <!--Table End-->
</div>
</form>
    <div>
