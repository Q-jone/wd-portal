...
<script src="<%=path%>/js/flick/jquery.ui.datepicker-zh-CN.js"></script>
	<script type="text/javascript">
      ...
      //跳转到新增页面
        function showViewPage(matchId){
        	sonWindow = window.open('showView.action?matchId='+matchId+'&checkRole=1');
        }
        	...
        	<table width="100%"  class="table_1">
                              ...
                              <tr>
                                ...
                                <s:if test="#data.HANDLER_ID.substring(0,12)==#session.t_login_name"> 
	                                <s:if test="#data.STATUS==@com.wonders.stpt.union.entity.bo.UnionMatch@MATCH_REVIEW_STATUS">
	                                	<a class="mr5" style="display: inline;cursor:pointer;" href="javascript:showViewPage('<s:property value="#data.ID"/>')" >审核</a>
	                                </s:if>
									<s:if test="#data.STATUS==@com.wonders.stpt.union.entity.bo.UnionMatch@PRIZE_SET_APPROVE_STATUS">
										<a class="mr5" style="display: inline;cursor:pointer;" href="javascript:confirmPrize('<s:property value="#data.ID"/>')" >预算审核</a>
									</s:if>
									<s:if test="#data.STATUS==@com.wonders.stpt.union.entity.bo.UnionMatch@PRIZE_ASSIGN_APPROVE_STATUS">
										<a class="mr5" style="display: inline;cursor:pointer;" href="javascript:confirmPrizeAssign('<s:property value="#data.ID"/>')" >名额分配审核</a>
									</s:if>										                                
                                </s:if>
                                ...
                                <a class="mr5" style="display: inline;cursor:pointer;" href="javascript:showView('<s:property value="#data.ID"/>')" >查看审批流程</a>
                                </td>
                                </tr>
                                </s:iterator>
                              </tbody>
