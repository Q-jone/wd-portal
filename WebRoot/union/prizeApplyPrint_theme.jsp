...
<div class="main f_bg">
    ...
    <div class="pt45">
        ...
        <table width="100%"  class="table_1">
            <tr>
                ...
                <h2>${theme.year}-${theme.themeName}</h2>
                </td>
            </tr>       
        </table>
    ...
    <s:iterator value="#request.matchList" id="match" status="s">
    	<div>
    	...
    	<s:if test="null!=#request.matchMap[#match.id]['appliedTeamPrizes'] && !#request.matchMap[#match.id]['appliedTeamPrizes'].isEmpty()"> 
	    <div>
	        ...
	        <table width="100%"  class="table_1">
	            ...
	            <s:iterator value="#request.matchMap[#match.id]['appliedTeamPrizes']" id="data" status="s">
	            <tr>
		...
		<s:if test="null!=#request.matchMap[#match.id]['appliedPersonalPrizes'] && !#request.matchMap[#match.id]['appliedPersonalPrizes'].isEmpty()">
	    <div>
	        ...
	        <table width="100%"  class="table_1">
	            ...
	            <s:iterator value="#request.matchMap[#match.id]['appliedPersonalPrizes']" id="data" status="s">
	            <tr>
	                <td class="t_c" width="30"><s:property value="#s.index+1"/></td>
	                <td class="t_c">${data.prize.prizeName}</td>
	                <td class="t_c">${data.name}</td>
	    ...
	    <s:if test="null!=#request.matchMap[#match.id]['appliedProjectPrizes'] && !#request.matchMap[#match.id]['appliedProjectPrizes'].isEmpty()">
	    <div>
	        ...
	        <table width="100%"  class="table_1">
	            ...
	            <s:iterator value="#request.matchMap[#match.id]['appliedProjectPrizes']" id="data" status="s">
	            <tr>
                <td class="t_c" width="30"><s:property value="#s.index+1"/></td>
                <td class="t_c">${data.prize.prizeName}</td>
    ...
    <s:if test="null!=#request.matchMap[#match.id]['appliedAchivementPrizes'] && !#request.matchMap[#match.id]['appliedAchivementPrizes'].isEmpty()">
    <div>
        ...
        <table width="100%"  class="table_1">
            ...
            <s:iterator value="#request.matchMap[#match.id]['appliedAchivementPrizes']" id="data" status="s">
            <tr>
                <td class="t_c" width="30"><s:property value="#s.index+1"/></td>
                <td class="t_c">${data.prize.prizeName}</td>
                <td class="t_c">${data.prjectName}</td>
