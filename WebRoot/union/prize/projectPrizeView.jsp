...
<center>
	<form name="form" method="post" id="form">
		...
		<div class="a_title">优秀创新项目审批表</div>
		<table width="829" border="0" class="a_table">
			<tr>
				<td style="text-align:center;" width="15%">申报类型</td>
				<td align="left" colspan="3">
					${projectPrize.projectType}
				</td>		
			</tr>	
			<tr>
				<td style="text-align:center;" width="15%">申报内容类型</td>
				<td align="left" colspan="3">
					${projectPrize.projectContentType}
				</td>		
			</tr>
			<tr>
			...
			<tr>
				<td style="text-align:center;" width="15%">承担单位</td>
				<td align="left" width="35%">
					${projectPrize.deptName}
				</td>
				<td style="text-align:center;" width="15%">负责人/电话</td>
				<td align="left">
					${projectPrize.responsibilePerson}/${projectPrize.telephone}
				</td>						
			</tr>
			<tr style="height:300px;">
				<td colspan="4">项目简介（300字左右，含项目成功、应用效益等）<br>
					${projectPrize.introduct}
				</td>
			</tr>								
			...
			<tr>
				<td colspan="4" style="height:150px;position:relative;padding:2px;padding-left:4px;">
					<div>
