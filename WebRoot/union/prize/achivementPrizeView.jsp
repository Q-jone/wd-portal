...
<center>
	<form name="form" method="post" id="form">
		...
		<div class="a_title">成果审批表</div>
		<table width="829" border="0" class="a_table">
			<tr>
				<td style="text-align:center;" width="15%">参赛板块</td>
				<td align="left" colspan="3">
					${achivementPrize.module}
				</td>		
			</tr>	
			<tr>
				<td style="text-align:center;" width="15%">项目名称</td>
				<td align="left" colspan="3">
					${achivementPrize.prjectName}
				</td>		
			</tr>						
			<tr>
				<td style="text-align:center;" width="15%">申报集体全称</td>
				<td align="left" width="45%">
					${achivementPrize.groupName}
				</td>
				<td style="text-align:center;" width="15%">负责人/电话</td>
				<td align="left" width="25%">
					${achivementPrize.responsibilePerson}/${achivementPrize.telephone}
				</td>						
			</tr>
			<tr style="height:300px;">
				<td colspan="4">项目简介（300字左右）<br>
					${achivementPrize.introduct}
				</td>
			</tr>								
