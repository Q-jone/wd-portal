...
<center>
	<form name="form" method="post" id="form">
		...
		<div class="a_title">先进集体审批表</div>
		<table width="829" border="0" class="a_table">
			<tr>
				<td style="text-align:center;" width="15%">集团全称</td>
				<td align="left" width="45%">
					${teamPrize.name}
				</td>
				<td style="text-align:center;" width="15%">人数</td>
