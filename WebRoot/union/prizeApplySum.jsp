...
<script src="<%=path%>/union/js/messagebox.js"></script>
	<script type="text/javascript">
        ...
        function showPrint(){
        	window.open('<%=path%>/unionPrize/prizeApplyPrintOfMatch.action?matchId=${match.id}');
        }     		
        
        function showApplicants(){
        	window.open('<%=path%>/unionApplyMatch/list.action?g=applicant&matchId=${match.id}');
        }
...
<div class="main f_bg">
            ...
            <tr>
                ...
                <tr class="tfoot nprint">
                    ...
                    <s:if test="#request.match.handlerId.substring(0,12)==#session.t_login_name">
	                    <s:if test="#request.match.status==@com.wonders.stpt.union.entity.bo.UnionMatch@ASSESS_SUM_STATUS || #request.match.status==@com.wonders.stpt.union.entity.bo.UnionMatch@ASSESS_SUM_REVIEW_STATUS">
    ...
    <div class="filter">
        <div class="fn clearfix">
            ...
            <div class="fr">
                <input type="button" id="showApplicantsBtn" onclick="showApplicants();" value="查 看 申 报 人" style="margin-left: 5px"/>
            </div>            
        </div>
    </div>    
	...
	<s:if test="#request.match.status==@com.wonders.stpt.union.entity.bo.UnionMatch@ASSESS_SUM_STATUS">
		<jsp:include page="flow/matchApply_firstReview.jsp"/>
	</s:if>
	<s:if test="#request.match.status==@com.wonders.stpt.union.entity.bo.UnionMatch@ASSESS_SUM_REVIEW_STATUS">
		<jsp:include page="flow/matchApply_deptReview.jsp"/>
	</s:if>	
</form>
