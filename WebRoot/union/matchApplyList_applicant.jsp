      ...
      <div style="padding-top: 20px;">
        <div class="filter">
            ...
            <div class="fn clearfix">
                <h5 class="fl"><a href="#" class="colSelect fl">专项申报人列表</a></h5>
            </div>
        </div>
        ...
        <div class="mb10">
        	<table width="100%"  class="table_1">
                              ...
                              <tr>
                                ...
                                <td class="t_c"><s:property value="#data.APPLY_DEPT_NAME"/></td>
                                <td class="t_c"><s:property value="#data.USER_NAME"/></td>
                                <td class="t_c">
                              ...
                              <tr class="tfoot">
                                ...
                                <td colspan="4"><div class="clearfix"><span class="fl"><s:property value="#request.pageResultSet.pageInfo.totalRow"/>条记录<s:if test="#request.pageResultSet.pageInfo.totalRow!=0">，当前显示<s:property value="#start"/>-<s:property value="#start+#request.pageResultSet.list.size-1"/>条</s:if></span>
