        ...
        <div class="mb10">
        	<table width="100%"  class="table_1">
                              ...
                              <tr>
                                ...
                                <td class="t_c"> 
                                <a class="mr5" style="display: inline;cursor:pointer;" href="<%=path%>/unionMatch/list.action?themeId=<s:property value="#data.ID"/>&g=<s:property value="#request.g"/>" target="_blank">竞赛专项</a>
