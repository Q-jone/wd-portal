...
<!--[if IE 6.0]>
	...
	<script type="text/javascript">
      ...
      var intHand = null;  
      function edit(id){
      		var url = "metroExpressEdit.action?metroExpressId="+id;
...
<body>
	...
	<div class="main">
      ...
      <div class="filter">
        	...
        	<s:form action="findMetroExpressManageListByPage" id="form" method="post"  namespace="/metroExpress">
        	    ...
        	    <tr>
        	     <td class="t_r">速报标题</td>
      	        ...
      	        <tr>
      	         <td class="t_r">有效性</td>
      	         <td>
        	      <select name="accidentActive" id="accidentActive" class="input_large" ></select>
        	     </td>
      	        </tr>
        ...
        <div class="mb10">
        	<table width="100%"  class="table_1">
                              ...
                              <tr>
                                ...
                                <td class="t_c"><s:property value="operatePerson"/></td>
                                <td class="t_c"><s:property value="operateTime"/></td>
                                <td class="t_c">
                                <s:if test="accidentActive==0">有效</s:if>
                                <s:elseif test="accidentActive==1">无效</s:elseif>
                                <s:else>无效</s:else>  
                                </td>
                                ...
                                <a class="mr5" href="javascript:deleteMetroExpress('<s:property value="id"/>')">删除</a>
                                </td>
                                </tr>
                                </s:iterator>
                              </tbody>
